 ...
 * {@link android.accounts.AccountManager AccountManager} call.  Methods are provided to check if the computation is
...
/**
 * Accessor for the future result the {@link android.accounts.AccountManagerFuture AccountManagerFuture} represents. This
...
public V getResult() throws android.accounts.AuthenticatorException, java.io.IOException, android.accounts.OperationCanceledException;
...
public V getResult(long timeout, java.util.concurrent.TimeUnit unit) throws android.accounts.AuthenticatorException, java.io.IOException, android.accounts.OperationCanceledException;
}
