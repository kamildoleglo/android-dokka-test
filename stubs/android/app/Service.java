 ...
 * {@link android.content.Context#startService(android.content.Intent) Context#startService(Intent)}, you can
 * also set {@link android.content.Intent#FLAG_GRANT_READ_URI_PERMISSION Intent#FLAG_GRANT_READ_URI_PERMISSION} and/or {@link android.content.Intent#FLAG_GRANT_WRITE_URI_PERMISSION Intent#FLAG_GRANT_WRITE_URI_PERMISSION} on the Intent.  This will grant the
 ...
 * importance can be adjusted through {@link android.content.Context#BIND_ABOVE_CLIENT Context#BIND_ABOVE_CLIENT},
 * {@link android.content.Context#BIND_ALLOW_OOM_MANAGEMENT Context#BIND_ALLOW_OOM_MANAGEMENT}, {@link android.content.Context#BIND_WAIVE_PRIORITY Context#BIND_WAIVE_PRIORITY},
 * {@link android.content.Context#BIND_IMPORTANT Context#BIND_IMPORTANT}, and {@link android.content.Context#BIND_ADJUST_WITH_ACTIVITY Context#BIND_ADJUST_WITH_ACTIVITY}.
 ...
 * {@link android.content.Context#startService(android.content.Intent) Context#startService(Intent)} to send
...
public Service() { super(null); throw new RuntimeException("Stub!"); }
...
/**
 * @deprecated Implement {@link #onStartCommand(android.content.Intent,int,int)} instead.
 * @apiSince 1
 * @deprecatedSince 15
 */
 ...
 * Value is either <code>0</code> or a combination of {@link android.app.Service#START_FLAG_REDELIVERY}, and {@link android.app.Service#START_FLAG_RETRY}
 ...
 *
 * Value is {@link android.app.Service#START_STICKY_COMPATIBILITY}, {@link android.app.Service#START_STICKY}, {@link android.app.Service#START_NOT_STICKY}, or {@link android.app.Service#START_REDELIVER_INTENT}
...
/**
 * If your service is started (running through {@link android.content.Context#startService(android.content.Intent) Context#startService(Intent)}), then
 ...
 * {@link #startService(android.content.Intent)} first to tell the system it should keep the service running,
 ...
 * {@link android.app.NotificationManager#notify(int,android.app.Notification) NotificationManager#notify(int, Notification)}; must not be 0.
 ...
 * @throws java.lang.IllegalArgumentException if param foregroundServiceType is not subset of manifest
 *     attribute {@link android.R.attr#foregroundServiceType}.
 * @see android.content.pm.ServiceInfo#FOREGROUND_SERVICE_TYPE_MANIFEST
 * @apiSince 29
 */

public final void startForeground(int id, @androidx.annotation.NonNull android.app.Notification notification, int foregroundServiceType) { throw new RuntimeException("Stub!"); }
 ...
 * Value is either <code>0</code> or a combination of {@link android.app.Service#STOP_FOREGROUND_REMOVE}, and {@link android.app.Service#STOP_FOREGROUND_DETACH}
 * @see #startForeground(int, Notification)
 * @apiSince 24
 */
 ...
 * in manifest, {@link android.content.pm.ServiceInfo#FOREGROUND_SERVICE_TYPE_NONE ServiceInfo#FOREGROUND_SERVICE_TYPE_NONE} is returned. </p>
 *
 * <p>If the service is not a foreground service,
 * {@link android.content.pm.ServiceInfo#FOREGROUND_SERVICE_TYPE_NONE ServiceInfo#FOREGROUND_SERVICE_TYPE_NONE} is returned.</p>
 *
...
public final int getForegroundServiceType() { throw new RuntimeException("Stub!"); }
 ...
 * named system services and which invokes the {@link android.os.IBinder#dump IBinder#dump} method
 * on the {@link android.os.IBinder IBinder} interface registered with ServiceManager.
 *
...
public static final int START_CONTINUATION_MASK = 15; // 0xf
...
public static final int START_FLAG_REDELIVERY = 1; // 0x1

/**
 * This flag is set in {@link #onStartCommand} if the Intent is a
 * retry because the original attempt never got to or returned from
 * {@link #onStartCommand(android.content.Intent,int,int)}.
 * @apiSince 5
 */

public static final int START_FLAG_RETRY = 2; // 0x2
 ...
 * {@link android.content.Context#startService Context#startService}.  The
 * service will not receive a {@link #onStartCommand(android.content.Intent,int,int)}
...
public static final int START_NOT_STICKY = 2; // 0x2
...
public static final int START_REDELIVER_INTENT = 3; // 0x3
...
public static final int START_STICKY = 1; // 0x1
...
public static final int START_STICKY_COMPATIBILITY = 0; // 0x0
...
public static final int STOP_FOREGROUND_DETACH = 2; // 0x2
...
public static final int STOP_FOREGROUND_REMOVE = 1; // 0x1
}
