 ...
 * {@link android.app.admin.DevicePolicyManager#ACTION_DEVICE_ADMIN_SERVICE DevicePolicyManager#ACTION_DEVICE_ADMIN_SERVICE} action, and tries to keep a bound
 ...
 * broadcast receiver instead, and have a {@link android.app.admin.DeviceAdminService DeviceAdminService} so that the process is always
 * running.
 *
...
public DeviceAdminService() { throw new RuntimeException("Stub!"); }
