...
/**
 * Defines the calling interface that {@link android.app.backup.BackupAgentHelper BackupAgentHelper} uses
 ...
 * helpers are performed sequentially by the {@link android.app.backup.BackupAgentHelper BackupAgentHelper}, with each
 ...
 * {@link android.app.backup.BackupAgent#onBackup(android.os.ParcelFileDescriptor,android.app.backup.BackupDataOutput,android.os.ParcelFileDescriptor) BackupAgent#onBackup(ParcelFileDescriptor, BackupDataOutput, ParcelFileDescriptor)} &mdash; the method parameters are the same.  When this method is invoked the
 ...
 * @param data An open, read/write {@link android.app.backup.BackupDataOutput BackupDataOutput}
 ...
 * <code>data</code>.</p>
 *
 * @param data An open {@link android.app.backup.BackupDataInputStream BackupDataInputStream} from which the backup data can be read.
 * @apiSince 8
 */
 ...
 * {@link #performBackup(android.os.ParcelFileDescriptor,android.app.backup.BackupDataOutput,android.os.ParcelFileDescriptor)
 * performBackup()} method.
 * <p>
 * This method will be called even if the handler's
 * {@link #restoreEntity(android.app.backup.BackupDataInputStream) restoreEntity()} method was never invoked during
