 ...
 * {@link android.content.Context#bindService Context#bindService} for more information.
...
public default void onBindingDied(android.content.ComponentName name) { throw new RuntimeException("Stub!"); }
 ...
 * {@link android.content.Context#unbindService(android.content.ServiceConnection) Context#unbindService(ServiceConnection)} to release the tracking
 * resources associated with this ServiceConnection even if this callback was
 * invoked following {@link android.content.Context#bindService Context#bindService}.
 *
...
public default void onNullBinding(android.content.ComponentName name) { throw new RuntimeException("Stub!"); }
}
