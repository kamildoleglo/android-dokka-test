...
/**
 * A cross process cursor is an extension of a {@link android.database.Cursor Cursor} that also supports
 * usage from remote processes.
 * <p>
 * The contents of a cross process cursor are marshalled to the remote process by
 * filling {@link android.database.CursorWindow CursorWindow} objects using {@link #fillWindow}.  As an optimization,
 ...
 * <p>
 * In particular, the window contains the row indicated by {@link android.database.Cursor#getPosition Cursor#getPosition}.
