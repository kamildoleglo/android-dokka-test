 ...
 * An {@code AudioFocusRequest} instance is built by {@link android.media.AudioFocusRequest.Builder Builder}, and is used to
 * request and abandon audio focus, respectively
 * with {@link android.media.AudioManager#requestAudioFocus(android.media.AudioFocusRequest) AudioManager#requestAudioFocus(AudioFocusRequest)} and
 * {@link android.media.AudioManager#abandonAudioFocusRequest(android.media.AudioFocusRequest) AudioManager#abandonAudioFocusRequest(AudioFocusRequest)}.
 *
 ...
 * <ul>
 * <li>{@link android.media.AudioManager#AUDIOFOCUS_GAIN AudioManager#AUDIOFOCUS_GAIN} expresses the fact that your application is now the
 ...
 *
 * <li>{@link android.media.AudioManager#AUDIOFOCUS_GAIN_TRANSIENT AudioManager#AUDIOFOCUS_GAIN_TRANSIENT} is for a situation when you know your
 ...
 *
 * <li>{@link android.media.AudioManager#AUDIOFOCUS_GAIN_TRANSIENT_MAY_DUCK AudioManager#AUDIOFOCUS_GAIN_TRANSIENT_MAY_DUCK}: this focus request type is similar
 ...
 *
 * <li>{@link android.media.AudioManager#AUDIOFOCUS_GAIN_TRANSIENT_EXCLUSIVE AudioManager#AUDIOFOCUS_GAIN_TRANSIENT_EXCLUSIVE} is also for a temporary request,
 ...
 * builder in the {@link android.media.AudioFocusRequest.Builder Builder} constructor
 * {@link android.media.AudioFocusRequest.Builder#AudioFocusRequest.Builder(int) AudioFocusRequest.Builder#AudioFocusRequest.Builder(int)}, or
 * with {@link android.media.AudioFocusRequest.Builder#setFocusGain(int) AudioFocusRequest.Builder#setFocusGain(int)} after copying an existing instance with
 * {@link android.media.AudioFocusRequest.Builder#AudioFocusRequest.Builder(android.media.AudioFocusRequest) AudioFocusRequest.Builder#AudioFocusRequest.Builder(AudioFocusRequest)}.
 *
 * <h3>Qualifying your focus request</h3>
 * <h4>Use case requiring a focus request</h4>
 * <p>Any focus request is qualified by the {@link android.media.AudioAttributes AudioAttributes}
 * (see {@link android.media.AudioFocusRequest.Builder#setAudioAttributes(android.media.AudioAttributes) Builder#setAudioAttributes(AudioAttributes)}) that describe the audio use case that
 ...
 * playback.
 * <br>If no attributes are set, default attributes of {@link android.media.AudioAttributes#USAGE_MEDIA AudioAttributes#USAGE_MEDIA} are used.
 *
 * <h4>Delayed focus</h4>
 ...
 * its request as accepting delayed focus, with {@link android.media.AudioFocusRequest.Builder#setAcceptsDelayedFocusGain(boolean) Builder#setAcceptsDelayedFocusGain(boolean)}.
 * <br>If focus is requested while being locked by the system,
 * {@link android.media.AudioManager#requestAudioFocus(android.media.AudioFocusRequest) AudioManager#requestAudioFocus(AudioFocusRequest)} will return
 * {@link android.media.AudioManager#AUDIOFOCUS_REQUEST_DELAYED AudioManager#AUDIOFOCUS_REQUEST_DELAYED}. When focus isn't locked anymore, the focus
 * listener set with {@link android.media.AudioFocusRequest.Builder#setOnAudioFocusChangeListener(android.media.AudioManager.OnAudioFocusChangeListener) Builder#setOnAudioFocusChangeListener(OnAudioFocusChangeListener)}
 * or with {@link android.media.AudioFocusRequest.Builder#setOnAudioFocusChangeListener(android.media.AudioManager.OnAudioFocusChangeListener,android.os.Handler) Builder#setOnAudioFocusChangeListener(OnAudioFocusChangeListener, Handler)} will
 ...
 * {@link android.media.AudioManager#AUDIOFOCUS_GAIN_TRANSIENT_MAY_DUCK AudioManager#AUDIOFOCUS_GAIN_TRANSIENT_MAY_DUCK}, the system will duck the current focus
 * owner.
 ...
 * loss of {@link android.media.AudioManager#AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK AudioManager#AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK}.
 ...
 * {@link android.media.AudioAttributes#CONTENT_TYPE_SPEECH AudioAttributes#CONTENT_TYPE_SPEECH}. Refer for instance to
 * {@link android.media.AudioAttributes.Builder#setContentType(int) AudioAttributes.Builder#setContentType(int)} and
 * {@link android.media.MediaPlayer#setAudioAttributes(android.media.AudioAttributes) MediaPlayer#setAudioAttributes(AudioAttributes)} if you are writing a media playback
 ...
 * {@link android.media.AudioManager#AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK AudioManager#AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK}, so they can pause instead. Note that
 ...
 * speech, you can also declare so with {@link android.media.AudioFocusRequest.Builder#setWillPauseWhenDucked(boolean) Builder#setWillPauseWhenDucked(boolean)}, which will
...
private AudioFocusRequest() { throw new RuntimeException("Stub!"); }

/**
 * Returns the {@link android.media.AudioAttributes AudioAttributes} set for this {@code AudioFocusRequest}, or the default
 * attributes if none were set.
 * @return non-null {@link android.media.AudioAttributes AudioAttributes}.
 * @apiSince 26
 */
 ...
 * @return one of {@link android.media.AudioManager#AUDIOFOCUS_GAIN AudioManager#AUDIOFOCUS_GAIN},
 * {@link android.media.AudioManager#AUDIOFOCUS_GAIN_TRANSIENT AudioManager#AUDIOFOCUS_GAIN_TRANSIENT},
 * {@link android.media.AudioManager#AUDIOFOCUS_GAIN_TRANSIENT_MAY_DUCK AudioManager#AUDIOFOCUS_GAIN_TRANSIENT_MAY_DUCK}, and
 * {@link android.media.AudioManager#AUDIOFOCUS_GAIN_TRANSIENT_EXCLUSIVE AudioManager#AUDIOFOCUS_GAIN_TRANSIENT_EXCLUSIVE}.
 * @apiSince 26
 */
...
/**
 * Builder class for {@link android.media.AudioFocusRequest AudioFocusRequest} objects.
 * <p>See {@link android.media.AudioFocusRequest AudioFocusRequest} for an example of building an instance with this builder.
 ...
 *     {@link android.media.AudioAttributes#USAGE_MEDIA AudioAttributes#USAGE_MEDIA}</td></tr>
 ...
 * have a usage of {@link android.media.AudioAttributes#USAGE_MEDIA AudioAttributes#USAGE_MEDIA}.
 * @param focusGain the type of audio focus gain that will be requested
 * @throws java.lang.IllegalArgumentException thrown when an invalid focus gain type is used
 * @apiSince 26
 */
 ...
 * @throws java.lang.IllegalArgumentException thrown when a null {@code AudioFocusRequest} is used.
 * @apiSince 26
 */

public Builder(@androidx.annotation.NonNull android.media.AudioFocusRequest requestToCopy) { throw new RuntimeException("Stub!"); }
 ...
 *   {@link android.media.AudioManager#requestAudioFocus(android.media.AudioFocusRequest) AudioManager#requestAudioFocus(AudioFocusRequest)}, and until being abandoned
 *   with {@link android.media.AudioManager#abandonAudioFocusRequest(android.media.AudioFocusRequest) AudioManager#abandonAudioFocusRequest(AudioFocusRequest)}.
 ...
 *   Notifications are delivered on the {@link android.os.Looper Looper} associated with the one of
 *   the creation of the {@link android.media.AudioManager AudioManager} used to request focus
 *   (see {@link android.media.AudioManager#requestAudioFocus(android.media.AudioFocusRequest) AudioManager#requestAudioFocus(AudioFocusRequest)}).
 * @param listener the listener receiving the focus change notifications.
 * This value must never be {@code null}.
 * @return this {@code Builder} instance.
 * @throws java.lang.NullPointerException thrown when a null focus listener is used.
 * @apiSince 26
 */

@androidx.annotation.NonNull
public android.media.AudioFocusRequest.Builder setOnAudioFocusChangeListener(@androidx.annotation.NonNull android.media.AudioManager.OnAudioFocusChangeListener listener) { throw new RuntimeException("Stub!"); }
 ...
 * @param listener the listener receiving the focus change notifications.
 * This value must never be {@code null}.
 * @param handler the {@link android.os.Handler Handler} for the thread on which to execute
 *   the notifications.
 * This value must never be {@code null}.
 * @return this {@code Builder} instance.
 * @throws java.lang.NullPointerException thrown when a null focus listener or handler is used.
 * @apiSince 26
 */

@androidx.annotation.NonNull
public android.media.AudioFocusRequest.Builder setOnAudioFocusChangeListener(@androidx.annotation.NonNull android.media.AudioManager.OnAudioFocusChangeListener listener, @androidx.annotation.NonNull android.os.Handler handler) { throw new RuntimeException("Stub!"); }

/**
 * Sets the {@link android.media.AudioAttributes AudioAttributes} to be associated with the focus request, and which
 ...
 * playback, see for example {@link android.media.MediaPlayer#setAudioAttributes(android.media.AudioAttributes) MediaPlayer#setAudioAttributes(AudioAttributes)} in
 * {@code MediaPlayer} or {@link android.media.AudioTrack.Builder#setAudioAttributes(android.media.AudioAttributes) AudioTrack.Builder#setAudioAttributes(AudioAttributes)}
 * in {@code AudioTrack}.
 * @param attributes the {@link android.media.AudioAttributes AudioAttributes} for the focus request.
 * This value must never be {@code null}.
 * @return this {@code Builder} instance.
 * @throws java.lang.NullPointerException thrown when using null for the attributes.
 * @apiSince 26
 */

@androidx.annotation.NonNull
public android.media.AudioFocusRequest.Builder setAudioAttributes(@androidx.annotation.NonNull android.media.AudioAttributes attributes) { throw new RuntimeException("Stub!"); }

/**
 * Declare the intended behavior of the application with regards to audio ducking.
 * See more details in the {@link android.media.AudioFocusRequest AudioFocusRequest} class documentation.
 * @param pauseOnDuck use {@code true} if the application intends to pause audio playback
 *    when losing focus with {@link android.media.AudioManager#AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK AudioManager#AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK}.
 *    If {@code true}, note that you must also set a focus listener to receive such an
 *    event, with
 *    {@link #setOnAudioFocusChangeListener(android.media.AudioManager.OnAudioFocusChangeListener,android.os.Handler)}.
 * @return this {@code Builder} instance.
 ...
 * See more details about delayed focus in the {@link android.media.AudioFocusRequest AudioFocusRequest} class
 * documentation.
 ...
 * with an {@link android.media.AudioAttributes AudioAttributes} usage of
 * {@link android.media.AudioAttributes#USAGE_ASSISTANCE_ACCESSIBILITY AudioAttributes#USAGE_ASSISTANCE_ACCESSIBILITY}, coming from an accessibility
 ...
 * @throws java.lang.IllegalStateException thrown when attempting to build a focus request that is set
