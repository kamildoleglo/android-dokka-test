 ...
 *
 * @see android.media.MediaSync#getTimestamp
 * @see android.media.MediaPlayer#getTimestamp
 * @apiSince 23
 */
...
public MediaTimestamp(long mediaTimeUs, long nanoTimeNs, float clockRate) { throw new RuntimeException("Stub!"); }
...
public long getAnchorSystemNanoTime() { throw new RuntimeException("Stub!"); }
 ...
 * @return Value is between 0.0f and Float.MAX_VALUE inclusive
 * @apiSince 23
 */
