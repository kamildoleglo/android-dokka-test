 ...
 *                   {@link android.media.AudioManager#STREAM_MUSIC AudioManager#STREAM_MUSIC}.
 * @param srcQuality the sample-rate converter quality. Currently has no
 *                   effect. Use 0 for the default.
 * @return a SoundPool object, or null if creation failed
 * @deprecated use {@link android.media.SoundPool.Builder SoundPool.Builder} instead to create and configure a
 *     SoundPool instance
 * @apiSince 1
 */
...
/**
 * Builder class for {@link android.media.SoundPool SoundPool} objects.
 * @apiSince 21
 */
 ...
 * {@link android.media.AudioAttributes#USAGE_MEDIA AudioAttributes#USAGE_MEDIA} (see {@link #setAudioAttributes(android.media.AudioAttributes)} to
 * change them).
 * @apiSince 21
 */
...
/**
 * Sets the {@link android.media.AudioAttributes AudioAttributes}. For examples, game applications will use attributes
 * built with usage information set to {@link android.media.AudioAttributes#USAGE_GAME AudioAttributes#USAGE_GAME}.
