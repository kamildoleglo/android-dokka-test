 ...
 * string for
 * {@link android.media.tv.TvContract.Programs#COLUMN_CONTENT_RATING TvContract.Programs#COLUMN_CONTENT_RATING}.
 ...
 * receiver that filters {@link android.media.tv.TvInputManager#ACTION_QUERY_CONTENT_RATING_SYSTEMS TvInputManager#ACTION_QUERY_CONTENT_RATING_SYSTEMS} in its manifest.
 *
...
private TvContentRating() { throw new RuntimeException("Stub!"); }
 ...
 * @throws java.lang.IllegalArgumentException If {@code domain}, {@code ratingSystem} or {@code rating} is
 *             {@code null}.
 * @apiSince 21
 */
...
/**
 * Returns the unmodifiable sub-rating string {@link java.util.List List} of this {@code TvContentRating}
 * object.
 * @apiSince 21
 */
 ...
 *
 * @param rating The {@link android.media.tv.TvContentRating TvContentRating} to check.
 * This value must never be {@code null}.
 * @return {@code true} if this object contains {@code rating}, {@code false} otherwise.
 * @apiSince 24
 */

public boolean contains(@androidx.annotation.NonNull android.media.tv.TvContentRating rating) { throw new RuntimeException("Stub!"); }
 ...
 *
 * <p>TV input services can call {@link android.media.tv.TvInputManager#isRatingBlocked TvInputManager#isRatingBlocked} with this constant to
 * determine whether they should block unrated content. The subsequent call to
 * {@link android.media.tv.TvInputService.Session#notifyContentBlocked TvInputService.Session#notifyContentBlocked} with the same constant notifies
