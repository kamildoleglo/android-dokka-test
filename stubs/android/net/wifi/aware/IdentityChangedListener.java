 ...
 * in {@link android.net.wifi.aware.WifiAwareSession#createNetworkSpecifierOpen(int,byte[]) WifiAwareSession#createNetworkSpecifierOpen(int, byte[])} or
 * {@link android.net.wifi.aware.WifiAwareSession#createNetworkSpecifierPassphrase(int,byte[],java.lang.String) WifiAwareSession#createNetworkSpecifierPassphrase(int, byte[], String)}.
 * @apiSince 26
 */
...
public IdentityChangedListener() { throw new RuntimeException("Stub!"); }
...
public void onIdentityChanged(byte[] mac) { throw new RuntimeException("Stub!"); }
}
