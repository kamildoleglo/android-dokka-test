...
/**
 * <p>HostNfcFService is a convenience {@link android.app.Service Service} class that can be
 ...
 * <p>A {@link android.nfc.cardemulation.HostNfcFService HostNfcFService} can register
 ...
 *
 * <p>All {@link android.nfc.cardemulation.HostNfcFService HostNfcFService} declarations in the manifest must require the
 ...
 * by using the {@link android.nfc.cardemulation.NfcFCardEmulation#registerSystemCodeForService(android.content.ComponentName,java.lang.String) NfcFCardEmulation#registerSystemCodeForService(ComponentName, String)} and
 * {@link android.nfc.cardemulation.NfcFCardEmulation#setNfcid2ForService(android.content.ComponentName,java.lang.String) NfcFCardEmulation#setNfcid2ForService(ComponentName, String)} methods.
 * </p>
 *
 ...
 * If a {@link android.nfc.cardemulation.NfcFCardEmulation NfcFCardEmulation} has registered
 ...
 * be sent through {@link #processNfcFPacket(byte[],android.os.Bundle)}, until the NFC link is
 * broken.<p>
 *
