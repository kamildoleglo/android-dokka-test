 ...
 * {@link android.content.pm.PackageManager#FEATURE_NFC_HOST_CARD_EMULATION_NFCF PackageManager#FEATURE_NFC_HOST_CARD_EMULATION_NFCF}
...
private NfcFCardEmulation() { throw new RuntimeException("Stub!"); }
 ...
 *
 * <p>Before calling {@link #registerSystemCodeForService(android.content.ComponentName,java.lang.String)},
 * the System Code contained in the Manifest file is returned. After calling
 * {@link #registerSystemCodeForService(android.content.ComponentName,java.lang.String)}, the System Code
 * registered there is returned. After calling
 * {@link #unregisterSystemCodeForService(android.content.ComponentName)}, "null" is returned.
 *
 ...
 *
 * <p>Before calling {@link #setNfcid2ForService(android.content.ComponentName,java.lang.String)},
 ...
 * with {@link #setNfcid2ForService(android.content.ComponentName,java.lang.String)}, this NFCID2 is returned.
 *
 * @param service The component name of the service
 ...
 * the background, {@link #disableService(android.app.Activity)} is called, or
 ...
 * {@link #disableService(android.app.Activity)} in your {@link android.app.Activity#onPause Activity#onPause}.
 *
