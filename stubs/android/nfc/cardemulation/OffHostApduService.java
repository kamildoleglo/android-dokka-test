...
/**
 * <p>OffHostApduService is a convenience {@link android.app.Service Service} class that can be
 ...
 * and some to another or a host-based {@link android.nfc.cardemulation.HostApduService HostApduService}.
 ...
 * the user preferred a {@link android.nfc.cardemulation.HostApduService HostApduService}), or to an off-host
 * execution environment (in case the user preferred a {@link android.nfc.cardemulation.OffHostApduService OffHostApduService}.
 *
