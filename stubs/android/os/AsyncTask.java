 ...
 * much utility over using {@link java.util.concurrent.Executor Executor}s directly.</p>
 *
 * <p>AsyncTask is designed to be a helper class around {@link java.lang.Thread Thread} and {@link android.os.Handler Handler}
 * and does not constitute a generic threading framework. AsyncTasks should ideally be
 * used for short operations (a few seconds at the most.) If you need to keep threads
 * running for long periods of time, it is highly recommended you use the various APIs
 * provided by the <code>java.util.concurrent</code> package such as {@link java.util.concurrent.Executor Executor},
 * {@link java.util.concurrent.ThreadPoolExecutor ThreadPoolExecutor} and {@link java.util.concurrent.FutureTask FutureTask}.</p>
 *
 ...
 * simply use the type {@link java.lang.Void Void}:</p>
 * <pre>
 ...
 * After invoking this method, {@link #onCancelled(java.lang.Object)}, instead of
 * {@link #onPostExecute(java.lang.Object)} will be invoked after {@link #doInBackground(java.lang.Object[])}
 * returns. To ensure that a task is cancelled as quickly as possible, you should always
 * check the return value of {@link #isCancelled()} periodically from
 * {@link #doInBackground(java.lang.Object[])}, if possible (inside a loop for instance.)</p>
 *
 ...
 * {@link #executeOnExecutor(java.util.concurrent.Executor,java.lang.Object[])} with
 ...
 * {@link #doInBackground(java.lang.Object[])} has finished.</p>
 *
 ...
 *               {@link #doInBackground(java.lang.Object[])}, can be null
 *
 * @see #cancel(boolean)
 * @see #isCancelled()
 * @apiSince 11
...
/**
 * <p>Applications should preferably override {@link #onCancelled(java.lang.Object)}.
 * This method is invoked by the default implementation of
 * {@link #onCancelled(java.lang.Object)}.
 * The default version does nothing.</p>
 *
 * <p>Runs on the UI thread after {@link #cancel(boolean)} is invoked and
 * {@link #doInBackground(java.lang.Object[])} has finished.</p>
 ...
 * {@link #doInBackground(java.lang.Object[])} to end the task as soon as possible.
 *
 ...
 *
 * <p>Calling this method will result in {@link #onCancelled(java.lang.Object)} being
 * invoked on the UI thread after {@link #doInBackground(java.lang.Object[])} returns.
 ...
 * {@link #doInBackground(java.lang.Object[])}.</p>
 *
...
@Deprecated
public final Result get() throws java.util.concurrent.ExecutionException, java.lang.InterruptedException { throw new RuntimeException("Stub!"); }
...
@Deprecated
public final Result get(long timeout, java.util.concurrent.TimeUnit unit) throws java.util.concurrent.ExecutionException, java.lang.InterruptedException, java.util.concurrent.TimeoutException { throw new RuntimeException("Stub!"); }
 ...
 *
 * @throws java.lang.IllegalStateException If {@link #getStatus()} returns either
 *         {@link android.os.AsyncTask.Status#RUNNING AsyncTask.Status#RUNNING} or {@link android.os.AsyncTask.Status#FINISHED AsyncTask.Status#FINISHED}.
 *
 ...
 * AsyncTask, however you can also use your own {@link java.util.concurrent.Executor Executor} for custom
 * behavior.
 *
...
/**
 * Convenience version of {@link #execute(java.lang.Object...)} for use with
 * a simple Runnable object. See {@link #execute(java.lang.Object[])} for more
...
/**
 * An {@link java.util.concurrent.Executor Executor} that executes tasks one at a time in serial
...
@Deprecated public static final java.util.concurrent.Executor SERIAL_EXECUTOR;
static { SERIAL_EXECUTOR = null; }

/**
 * An {@link java.util.concurrent.Executor Executor} that can be used to execute tasks in parallel.
 *
 ...
 *   create an {@link java.util.concurrent.Executor Executor} configured for your use case.
 * @apiSince 11
 * @deprecatedSince R
 */

@Deprecated public static final java.util.concurrent.Executor THREAD_POOL_EXECUTOR;
static { THREAD_POOL_EXECUTOR = null; }
/**
...
RUNNING,
/**
 * Indicates that {@link android.os.AsyncTask#onPostExecute AsyncTask#onPostExecute} has finished.
 * @apiSince 3
 * @deprecatedSince R
 */
