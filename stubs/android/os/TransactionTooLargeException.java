 ...
 * are transferred as {@link android.os.Parcel Parcel} objects stored in the Binder transaction buffer.
 * If the arguments or the return value are too large to fit in the transaction buffer,
 * then the call will fail and {@link android.os.TransactionTooLargeException TransactionTooLargeException} will be thrown.
 * </p><p>
 ...
 * {@link android.os.TransactionTooLargeException TransactionTooLargeException}.  Either the client was unable to send
 ...
 * </p><p>
 * The key to avoiding {@link android.os.TransactionTooLargeException TransactionTooLargeException} is to keep all
 * transactions relatively small.  Try to minimize the amount of memory needed to create
 * a {@link android.os.Parcel Parcel} for the arguments and the return value of the remote procedure call.
...
public TransactionTooLargeException() { throw new RuntimeException("Stub!"); }

/** @apiSince 23 */

public TransactionTooLargeException(java.lang.String msg) { throw new RuntimeException("Stub!"); }
}
