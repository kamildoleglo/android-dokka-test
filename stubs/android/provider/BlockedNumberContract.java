 ...
 * accessing this table are defined by the {@link android.provider.BlockedNumberContract.BlockedNumbers BlockedNumbers} class. Messages, and calls from
 ...
 * provider. However, {@link #canCurrentUserBlockNumbers(android.content.Context)} can be accessed by any
 * application.
 * </p>
 *
 * <h3> Data </h3>
 ...
 * in the {@link android.provider.BlockedNumberContract.BlockedNumbers#COLUMN_ORIGINAL_NUMBER BlockedNumbers#COLUMN_ORIGINAL_NUMBER} column. A normalized version of phone
 * numbers (if normalization is possible) is stored in {@link android.provider.BlockedNumberContract.BlockedNumbers#COLUMN_E164_NUMBER BlockedNumbers#COLUMN_E164_NUMBER}
 * column. The platform blocks calls, and messages from an address if it is present in in the
 * {@link android.provider.BlockedNumberContract.BlockedNumbers#COLUMN_ORIGINAL_NUMBER BlockedNumbers#COLUMN_ORIGINAL_NUMBER} column or if the E164 version of the address
 * matches the {@link android.provider.BlockedNumberContract.BlockedNumbers#COLUMN_E164_NUMBER BlockedNumbers#COLUMN_E164_NUMBER} column.
 * </p>
 *
 * <h3> Operations </h3>
 * <dl>
 ...
 * <dd>
 * <p>
 * {@link android.provider.BlockedNumberContract.BlockedNumbers#COLUMN_ORIGINAL_NUMBER BlockedNumbers#COLUMN_ORIGINAL_NUMBER} is a required column that needs to be populated.
 * Apps can optionally provide the {@link android.provider.BlockedNumberContract.BlockedNumbers#COLUMN_E164_NUMBER BlockedNumbers#COLUMN_E164_NUMBER} which is the phone
 ...
 * {@link android.provider.BlockedNumberContract.BlockedNumbers#COLUMN_ORIGINAL_NUMBER BlockedNumbers#COLUMN_ORIGINAL_NUMBER} column) will result in replacing the existing
 * blocked number.
 * <p>
 * Examples:
 * <pre>
 ...
 * {@link #isBlocked(android.content.Context,java.lang.String)}.
 * </p>
 * </dd>
 * <dt><b>Query</b></dt>
 * <dd>
 ...
 * <dd>
 * <p>
 * Use the method {@link #unblock(android.content.Context,java.lang.String)} to unblock numbers.
 * </p>
 * </dd>
 *
 * <h3> Multi-user </h3>
 * <p>
 * Apps must use the method {@link #canCurrentUserBlockNumbers(android.content.Context)} before performing any
 * operation on the blocked number provider. If {@link #canCurrentUserBlockNumbers(android.content.Context)} returns
 * {@code false}, all operations on the provider will fail with a {@link java.lang.SecurityException SecurityException}. The
...
private BlockedNumberContract() { throw new RuntimeException("Stub!"); }

/**
 * Returns whether a given number is in the blocked list.
 *
 * <p> This matches the {@code phoneNumber} against the
 * {@link android.provider.BlockedNumberContract.BlockedNumbers#COLUMN_ORIGINAL_NUMBER BlockedNumbers#COLUMN_ORIGINAL_NUMBER} column, and the E164 representation of the
 * {@code phoneNumber} with the {@link android.provider.BlockedNumberContract.BlockedNumbers#COLUMN_E164_NUMBER BlockedNumbers#COLUMN_E164_NUMBER} column.
 *
 * <p> Note that if the {@link #canCurrentUserBlockNumbers} is {@code false} for the user
 * context {@code context}, this method will throw a {@link java.lang.SecurityException SecurityException}.
 *
 * <br>
 ...
 * {@link android.provider.BlockedNumberContract.BlockedNumbers#COLUMN_ORIGINAL_NUMBER BlockedNumbers#COLUMN_ORIGINAL_NUMBER} column or the E164 representation of the
 * {@code phoneNumber} matches the {@link android.provider.BlockedNumberContract.BlockedNumbers#COLUMN_E164_NUMBER BlockedNumbers#COLUMN_E164_NUMBER} column.
 *
 * <p>To delete rows based on exact match with specific columns such as
 * {@link android.provider.BlockedNumberContract.BlockedNumbers#COLUMN_ID BlockedNumbers#COLUMN_ID} use
 * {@link android.content.ContentProvider#delete(Uri, String, String[])} with
 * {@link android.provider.BlockedNumberContract.BlockedNumbers#CONTENT_URI BlockedNumbers#CONTENT_URI} URI.
 *
 * <p> Note that if the {@link #canCurrentUserBlockNumbers} is {@code false} for the user
 * context {@code context}, this method will throw a {@link java.lang.SecurityException SecurityException}.
 *
...
private BlockedNumbers() { throw new RuntimeException("Stub!"); }
