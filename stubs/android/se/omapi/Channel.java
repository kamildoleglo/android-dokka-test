 ...
 * @throws java.io.IOException if there is a communication problem to the reader or the Secure Element.
 * @throws java.lang.IllegalStateException if the channel is used after being closed.
 * @throws java.lang.IllegalArgumentException if the command byte array is less than 4 bytes long.
 * @throws java.lang.IllegalArgumentException if Lc byte is inconsistent with length of the byte array.
 * @throws java.lang.IllegalArgumentException if CLA byte is invalid according to [2] (0xff).
 * @throws java.lang.IllegalArgumentException if INS byte is invalid according to [2] (0x6x or 0x9x).
 * @throws java.lang.SecurityException if the command is filtered by the security policy.
 * @throws java.lang.NullPointerException if command is NULL.
 * @apiSince 28
 */

@androidx.annotation.NonNull
public byte[] transmit(@androidx.annotation.NonNull byte[] command) throws java.io.IOException { throw new RuntimeException("Stub!"); }
 ...
 * @throws java.io.IOException if there is a communication problem to the reader or the Secure Element.
 * @throws java.lang.IllegalStateException if the channel is used after being closed.
 * @throws java.lang.UnsupportedOperationException if this operation is not supported by the card.
 * @apiSince 28
 */
