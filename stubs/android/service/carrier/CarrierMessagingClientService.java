...
public CarrierMessagingClientService() { throw new RuntimeException("Stub!"); }
...
public final android.os.IBinder onBind(@androidx.annotation.Nullable android.content.Intent intent) { throw new RuntimeException("Stub!"); }
}
