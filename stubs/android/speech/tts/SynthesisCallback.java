 ...
 *
 * <p>This method should only be called on the synthesis thread, while in {@link android.speech.tts.TextToSpeechService#onSynthesizeText TextToSpeechService#onSynthesizeText}.
 *
 * @param sampleRateInHz Sample rate in HZ of the generated audio.
 * @param audioFormat Audio format of the generated audio. Must be one of {@link android.media.AudioFormat#ENCODING_PCM_8BIT AudioFormat#ENCODING_PCM_8BIT} or {@link android.media.AudioFormat#ENCODING_PCM_16BIT AudioFormat#ENCODING_PCM_16BIT}. Can also be
 *     {@link android.media.AudioFormat#ENCODING_PCM_FLOAT AudioFormat#ENCODING_PCM_FLOAT} when targetting Android N and above.
 * Value is {@link android.media.AudioFormat#ENCODING_PCM_8BIT}, {@link android.media.AudioFormat#ENCODING_PCM_16BIT}, or {@link android.media.AudioFormat#ENCODING_PCM_FLOAT}
 ...
 * Value is {@link android.speech.tts.TextToSpeech#ERROR_SYNTHESIS}, {@link android.speech.tts.TextToSpeech#ERROR_SERVICE}, {@link android.speech.tts.TextToSpeech#ERROR_OUTPUT}, {@link android.speech.tts.TextToSpeech#ERROR_NETWORK}, {@link android.speech.tts.TextToSpeech#ERROR_NETWORK_TIMEOUT}, {@link android.speech.tts.TextToSpeech#ERROR_INVALID_REQUEST}, or {@link android.speech.tts.TextToSpeech#ERROR_NOT_INSTALLED_YET}
 * @apiSince 21
 */
 ...
 * listener ({@link android.speech.tts.UtteranceProgressListener#onRangeStart UtteranceProgressListener#onRangeStart}) at the moment that frame has been
 ...
 * definition of a frame depends on the format given by {@link #start}. See {@link android.media.AudioFormat AudioFormat}
...
public default void rangeStart(int markerInFrames, int start, int end) { throw new RuntimeException("Stub!"); }
}
