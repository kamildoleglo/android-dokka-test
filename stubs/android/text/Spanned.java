 ...
 * see {@link android.text.Spannable Spannable} for mutable markup and {@link android.text.Editable Editable} for
 * mutable text.
 * @apiSince 1
 */
...
/**
 * Return the flags that were specified when {@link android.text.Spannable#setSpan Spannable#setSpan} was
...
public static final int SPAN_COMPOSING = 256; // 0x100
...
public static final int SPAN_EXCLUSIVE_EXCLUSIVE = 33; // 0x21
...
public static final int SPAN_EXCLUSIVE_INCLUSIVE = 34; // 0x22
...
public static final int SPAN_INCLUSIVE_EXCLUSIVE = 17; // 0x11
...
public static final int SPAN_INCLUSIVE_INCLUSIVE = 18; // 0x12
 ...
 * used for {@link android.text.Selection Selection} which automatically uses this with the first
 * offset it sets when updating the selection.
 * @apiSince 3
 */

public static final int SPAN_INTERMEDIATE = 512; // 0x200
...
public static final int SPAN_MARK_MARK = 17; // 0x11
...
public static final int SPAN_MARK_POINT = 18; // 0x12
...
public static final int SPAN_PARAGRAPH = 51; // 0x33
...
public static final int SPAN_POINT_MARK = 33; // 0x21
...
public static final int SPAN_POINT_MARK_MASK = 51; // 0x33
...
public static final int SPAN_POINT_POINT = 34; // 0x22
...
public static final int SPAN_PRIORITY = 16711680; // 0xff0000
...
public static final int SPAN_PRIORITY_SHIFT = 16; // 0x10
...
public static final int SPAN_USER = -16777216; // 0xff000000
...
public static final int SPAN_USER_SHIFT = 24; // 0x18
}
