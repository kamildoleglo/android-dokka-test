...
/**
 * @deprecated Use {@link #DateKeyListener(java.util.Locale)} instead.
 * @apiSince 1
 */
...
public DateKeyListener(@androidx.annotation.Nullable java.util.Locale locale) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.NonNull
public static android.text.method.DateKeyListener getInstance(@androidx.annotation.Nullable java.util.Locale locale) { throw new RuntimeException("Stub!"); }
