...
/**
 * @deprecated Use {@link #TimeKeyListener(java.util.Locale)} instead.
 * @apiSince 1
 */
...
public TimeKeyListener(@androidx.annotation.Nullable java.util.Locale locale) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.NonNull
public static android.text.method.TimeKeyListener getInstance(@androidx.annotation.Nullable java.util.Locale locale) { throw new RuntimeException("Stub!"); }
