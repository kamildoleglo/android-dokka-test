 ...
 * TextView, it may appear cut. This can be avoided by decreasing the text size with an {@link android.text.style.AbsoluteSizeSpan AbsoluteSizeSpan}
 * @apiSince 1
 */
...
/**
 * Creates a {@link android.text.style.SuperscriptSpan SuperscriptSpan}.
 * @apiSince 1
 */
...
/**
 * Creates a {@link android.text.style.SuperscriptSpan SuperscriptSpan} from a parcel.
 
 * @param src This value must never be {@code null}.
 * @apiSince 3
 */

public SuperscriptSpan(@androidx.annotation.NonNull android.os.Parcel src) { throw new RuntimeException("Stub!"); }
