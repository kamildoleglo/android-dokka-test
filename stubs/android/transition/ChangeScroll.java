...
public ChangeScroll() { throw new RuntimeException("Stub!"); }

/** @apiSince 23 */

public ChangeScroll(android.content.Context context, android.util.AttributeSet attrs) { throw new RuntimeException("Stub!"); }
