 ...
 * in a <em>host</em> object. The Property's {@link #set(java.lang.Object,java.lang.Object)} or {@link #get(java.lang.Object)}
 ...
 * {@link #isReadOnly() readOnly}. Calling the {@link #set(java.lang.Object,java.lang.Object)} method on such
 * a property is allowed, but will have no effect.</p>
 *
 * <p>If neither the methods nor the field are found on the class a
 * {@link android.util.NoSuchPropertyException NoSuchPropertyException} exception will be thrown.</p>
 * @apiSince 14
 */
...
/**
 * Returns true if the {@link #set(java.lang.Object,java.lang.Object)} method does not set the value on the target
 * object (in which case the {@link #set(java.lang.Object,java.lang.Object) set()} method should throw a {@link android.util.NoSuchPropertyException NoSuchPropertyException} exception). This may happen if the Property wraps functionality that
 * allows querying the underlying value but not setting it. For example, the {@link #of(java.lang.Class,java.lang.Class,java.lang.String)} factory method may return a Property with name "foo" for an object that has
 ...
 * to set the value on the target object it will throw an {@link java.lang.UnsupportedOperationException UnsupportedOperationException}
 * exception.
 * @apiSince 14
 */
