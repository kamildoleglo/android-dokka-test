...
/**
 * Subclass of {@link android.view.Menu Menu} for sub menus.
 * <p>
...
/**
 * Sets the header of the submenu to the {@link android.view.View View} given in
 ...
 * Change the icon associated with this submenu's item in its parent menu.
 *
 * @see android.view.MenuItem#setIcon(Drawable)
...
/**
 * Gets the {@link android.view.MenuItem MenuItem} that represents this submenu in the parent
 * menu.  Use this for setting additional item attributes.
 *
 * @return The {@link android.view.MenuItem MenuItem} that launches the submenu when invoked.
 * @apiSince 1
 */
