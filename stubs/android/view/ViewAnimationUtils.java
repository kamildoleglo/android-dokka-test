...
private ViewAnimationUtils() { throw new RuntimeException("Stub!"); }
 ...
 * {@link android.view.View#setClipToOutline(boolean) View#setClipToOutline(boolean)}.
 * <p>
 ...
 * As a result {@link android.animation.Animator.AnimatorListener#onAnimationEnd(android.animation.Animator) AnimatorListener#onAnimationEnd(Animator)}
...
public static android.animation.Animator createCircularReveal(android.view.View view, int centerX, int centerY, float startRadius, float endRadius) { throw new RuntimeException("Stub!"); }
}
