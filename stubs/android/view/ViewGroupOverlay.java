 ...
 *
 * <p>ViewGroupOverlay is a subclass of {@link android.view.ViewOverlay ViewOverlay}, adding the ability to
 * manage views for overlays on ViewGroups, in addition to the drawable
 * support in ViewOverlay.</p>
 *
 * @see android.view.ViewGroup#getOverlay()
 * @apiSince 18
 */
...
ViewGroupOverlay() { throw new RuntimeException("Stub!"); }
 ...
 * {@code Drawable}s added with {@link #add(android.graphics.drawable.Drawable)} API even if a call to
 * this API happened after the call to {@link #add(android.graphics.drawable.Drawable)}.</p>
 *
 * <p>Passing <code>null</code> parameter will result in an
 * {@link java.lang.IllegalArgumentException IllegalArgumentException} being thrown.</p>
 *
...
public void add(@androidx.annotation.NonNull android.view.View view) { throw new RuntimeException("Stub!"); }

/**
 * Removes the specified {@code View} from the overlay. Passing <code>null</code> parameter
 * will result in an {@link java.lang.IllegalArgumentException IllegalArgumentException} being thrown.
 *
...
public void remove(@androidx.annotation.NonNull android.view.View view) { throw new RuntimeException("Stub!"); }
}
