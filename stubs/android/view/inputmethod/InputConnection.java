 ...
 * {@link android.view.inputmethod.InputMethod InputMethod} back to the application that is receiving its
 ...
 *     <li>{@link #commitCorrection(android.view.inputmethod.CorrectionInfo)}, which was introduced
 ...
 *     {@link android.os.Build.VERSION_CODES#N}.</li>
 *     <li>{@link #commitContent(android.view.inputmethod.InputContentInfo,int,android.os.Bundle)}, which was
 ...
 * to provide your own subclass of {@link android.view.inputmethod.BaseInputConnection BaseInputConnection} to
 ...
 * {@link android.view.inputmethod.InputConnection#setComposingText(java.lang.CharSequence,int) InputConnection#setComposingText(CharSequence, int)},
 * {@link android.view.inputmethod.InputConnection#setComposingRegion(int,int) InputConnection#setComposingRegion(int, int)} and
 * {@link android.view.inputmethod.InputConnection#finishComposingText() InputConnection#finishComposingText()}.
 ...
 * {@link android.view.inputmethod.EditorInfo#inputType EditorInfo#inputType} value
 * directly in to here.
 ...
 * calling
 * {@link android.view.inputmethod.InputMethodManager#updateExtractedText(View,int,android.view.inputmethod.ExtractedText) InputMethodManager#updateExtractedText(View, int, ExtractedText)}
 * whenever you call
 * {@link android.view.inputmethod.InputMethodManager#updateSelection(View,int,int,int,int) InputMethodManager#updateSelection(View, int, int, int, int)}.</p>
 *
 ...
 * {@link android.view.inputmethod.InputMethodManager#updateSelection(View,int,int,int,int) InputMethodManager#updateSelection(View, int, int, int, int)},
 ...
 * {@link android.view.inputmethod.InputMethodManager#updateSelection(View,int,int,int,int) InputMethodManager#updateSelection(View, int, int, int, int)} and
 ...
 * {@link #setComposingText(java.lang.CharSequence,int) setComposingText(text, newCursorPosition)}
 ...
 * previously reported to {@link android.view.inputmethod.InputMethodSession#displayCompletions InputMethodSession#displayCompletions} or
 * {@link android.view.inputmethod.InputMethodManager#displayCompletions InputMethodManager#displayCompletions}.
 * This will result in the same behavior as if the user had
 * selected the completion from the actual UI. In all other
 * respects, this behaves like {@link #commitText(java.lang.CharSequence,int)}.
 *
 ...
 * {@link android.view.inputmethod.InputMethodSession#displayCompletions(android.view.inputmethod.CompletionInfo[]) InputMethodSession#displayCompletions(CompletionInfo[])} or
 * {@link android.view.inputmethod.InputMethodManager#displayCompletions(View,android.view.inputmethod.CompletionInfo[]) InputMethodManager#displayCompletions(View, CompletionInfo[])} then
 * a well-behaved IME should never call this on your input
 * connection, but be ready to deal with misbehaving IMEs without
 * crashing.</p>
 *
 * <p>Calling this method (with a valid {@link android.view.inputmethod.CompletionInfo CompletionInfo} object)
 ...
 * {@link android.view.inputmethod.EditorInfo#imeOptions EditorInfo#imeOptions}, such as
 * {@link android.view.inputmethod.EditorInfo#IME_ACTION_GO EditorInfo#IME_ACTION_GO}.
 * @return true on success, false if the input connection is no longer
 * valid.
 * @apiSince 3
 */
 ...
 * {@link android.view.KeyEvent#FLAG_SOFT_KEYBOARD KeyEvent#FLAG_SOFT_KEYBOARD}
 ...
 * @see android.view.KeyCharacterMap#NUMERIC
 * @see android.view.KeyCharacterMap#PREDICTIVE
 * @see android.view.KeyCharacterMap#ALPHA
 * @apiSince 3
 */
 ...
 * per {@link android.view.KeyEvent#getMetaState() KeyEvent#getMetaState()}.
 * @return true on success, false if the input connection is no longer
 * valid.
 * @apiSince 3
 */
 ...
 * {@link android.inputmethodservice.InputMethodService#updateFullscreenMode() InputMethodService#updateFullscreenMode()} instead. This approach should work on API
 ...
 *         devices.
 * @see android.view.inputmethod.InputMethodManager#isFullscreenMode()
 * @apiSince 3
 */
 ...
 * information in {@link android.view.inputmethod.EditorInfo EditorInfo} to determine if a client
 ...
 * {@link android.view.inputmethod.InputMethodManager#updateCursorAnchorInfo(android.view.View,android.view.inputmethod.CursorAnchorInfo) InputMethodManager#updateCursorAnchorInfo(android.view.View, CursorAnchorInfo)} to
 ...
 * {@link android.view.inputmethod.InputMethodManager#updateCursorAnchorInfo(android.view.View,android.view.inputmethod.CursorAnchorInfo) InputMethodManager#updateCursorAnchorInfo(android.view.View, CursorAnchorInfo)}.
...
/**
 * Called by the {@link android.view.inputmethod.InputMethodManager InputMethodManager} to enable application developers to specify a
 * dedicated {@link android.os.Handler Handler} on which incoming IPC method calls from input methods will be
 * dispatched.
 *
 * <p>Note: This does nothing when called from input methods.</p>
 *
 * @return {@code null} to use the default {@link android.os.Handler Handler}.
 * @apiSince 24
 */
 ...
 * <ul>
 *     <li>Editor must keep {@link android.view.inputmethod.EditorInfo#contentMimeTypes EditorInfo#contentMimeTypes} equal to {@code null} if it does
 *     not support this method at all.</li>
 *     <li>Editor can ignore this request when the MIME type specified in
 *     {@code inputContentInfo} does not match any of {@link android.view.inputmethod.EditorInfo#contentMimeTypes EditorInfo#contentMimeTypes}.
 *     </li>
 ...
 *     {@link android.view.inputmethod.EditorInfo#packageName EditorInfo#packageName} about how to obtain the package name of the editor.</li>
 * </ul>
 *
 ...
 * {@link android.view.inputmethod.InputContentInfo#requestPermission() InputContentInfo#requestPermission()}.
...
public boolean commitContent(@androidx.annotation.NonNull android.view.inputmethod.InputContentInfo inputContentInfo, int flags, @androidx.annotation.Nullable android.os.Bundle opts);

/**
 * The editor is requested to call
 * {@link android.view.inputmethod.InputMethodManager#updateCursorAnchorInfo(android.view.View,android.view.inputmethod.CursorAnchorInfo) InputMethodManager#updateCursorAnchorInfo(android.view.View, CursorAnchorInfo)} at
 ...
 * {@link android.view.inputmethod.InputConnection#requestCursorUpdates(int) InputConnection#requestCursorUpdates(int)} again with this flag off.
 * <p>
 ...
 * contained in the {@link android.view.inputmethod.InputContentInfo InputContentInfo} object.
 *
 * <p>Make sure that the content provider owning the Uri sets the
 * {@link android.R.styleable#AndroidManifestProvider_grantUriPermissions
 * grantUriPermissions} attribute in its manifest or included the
 * {@link android.R.styleable#AndroidManifestGrantUriPermission
 * &lt;grant-uri-permissions&gt;} tag. Otherwise {@link android.view.inputmethod.InputContentInfo#requestPermission() InputContentInfo#requestPermission()}
 * can fail.</p>
 *
 ...
 * to any other IME as long as the client keeps {@link android.view.inputmethod.InputContentInfo InputContentInfo} object.</p>
 *     * @apiSince 25
 */
