...
public android.view.View getEmbeddedView(int NPP, android.content.Context context);
...
public android.view.View getFullScreenView(int NPP, android.content.Context context);
}
