 ...
 * {@link android.widget.ExpandableListAdapter ExpandableListAdapter} take advantage of the {@link android.widget.Adapter Adapter} view type
 * mechanism.
 * <p>
 * An {@link android.widget.ExpandableListAdapter ExpandableListAdapter} declares it has one view type for its group items
 * and one view type for its child items. Although adapted for most {@link android.widget.ExpandableListView ExpandableListView}s,
 * these values should be tuned for heterogeneous {@link android.widget.ExpandableListView ExpandableListView}s.
 * </p>
