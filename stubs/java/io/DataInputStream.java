...
public DataInputStream(java.io.InputStream in) { super(null); throw new RuntimeException("Stub!"); }
...
public final int skipBytes(int n) throws java.io.IOException { throw new RuntimeException("Stub!"); }
 ...
 *             input stream does not support reading after close, or
 *             another I/O error occurs.
 * @exception  java.io.UTFDataFormatException if the bytes do not represent a valid
 ...
 * @return     a Unicode string.
 * @exception  java.io.EOFException            if the input stream reaches the end
