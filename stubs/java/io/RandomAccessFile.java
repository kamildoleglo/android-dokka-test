 ...
 * {@link java.io.FileDescriptor FileDescriptor} object is created to represent the
 ...
 * @exception  java.lang.IllegalArgumentException  if the mode argument is not equal
...
public RandomAccessFile(java.lang.String name, java.lang.String mode) throws java.io.FileNotFoundException { throw new RuntimeException("Stub!"); }

/**
 * Creates a random access file stream to read from, and optionally to
 * write to, the file specified by the {@link java.io.File File} argument.  A new {@link java.io.FileDescriptor FileDescriptor} object is created to represent this file connection.
 *
 ...
 * way as the {@link java.io.InputStream#read() InputStream#read()} method of
 * {@code InputStream}.
 *
 ...
 * same way as the {@link java.io.InputStream#read(byte[],int,int) InputStream#read(byte[], int, int)} method of
 * {@code InputStream}.
 *
 ...
 * @exception  java.lang.NullPointerException If {@code b} is {@code null}.
 * @exception  java.lang.IndexOutOfBoundsException If {@code off} is negative,
 ...
 * Although {@code RandomAccessFile} is not a subclass of
 * {@code InputStream}, this method behaves in exactly the
 * same way as the {@link java.io.InputStream#read(byte[]) InputStream#read(byte[])} method of
 * {@code InputStream}.
 *
 * @param      b   the buffer into which the data is read.
 * @return     the total number of bytes read into the buffer, or
...
public final void readFully(byte[] b) throws java.io.IOException { throw new RuntimeException("Stub!"); }
...
public final void readFully(byte[] b, int off, int len) throws java.io.IOException { throw new RuntimeException("Stub!"); }
...
public int skipBytes(int n) throws java.io.IOException { throw new RuntimeException("Stub!"); }
