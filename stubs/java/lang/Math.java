 ...
 * {@link java.lang.Integer#MIN_VALUE Integer#MIN_VALUE}, the most negative representable
 ...
 *
 * <p>Note that if the argument is equal to the value of
 * {@link java.lang.Long#MIN_VALUE Long#MIN_VALUE}, the most negative representable
 ...
 * {@link java.lang.Integer#MAX_VALUE Integer#MAX_VALUE}. If the arguments have the same value,
 ...
 * result is the argument closer to the value of
 * {@link java.lang.Long#MAX_VALUE Long#MAX_VALUE}. If the arguments have the same value,
 * the result is that same value.
 *
 * @param   a   an argument.
 * @param   b   another argument.
 ...
 * {@link java.lang.Integer#MIN_VALUE Integer#MIN_VALUE}.  If the arguments have the same
 ...
 * {@link java.lang.Long#MIN_VALUE Long#MIN_VALUE}. If the arguments have the same
 * value, the result is that same value.
 *
 * @param   a   an argument.
 * @param   b   another argument.
 ...
 * second floating-point argument.  Note that unlike the {@link java.lang.StrictMath#copySign(double,double) StrictMath#copySign(double, double)}
...
/**
 * Returns the first floating-point argument with the sign of the
 * second floating-point argument.  Note that unlike the {@link java.lang.StrictMath#copySign(float,float) StrictMath#copySign(float, float)}
 * method, this method does not require NaN {@code sign}
 * arguments to be treated as positive values; implementations are
 * permitted to treat some NaN arguments as positive and other NaN
 * arguments as negative to allow greater performance.
 ...
 * {@link java.lang.Float#MAX_EXPONENT Float#MAX_EXPONENT} + 1.
 * <li>If the argument is zero or subnormal, then the result is
 * {@link java.lang.Float#MIN_EXPONENT Float#MIN_EXPONENT} -1.
 * </ul>
 ...
 * <ul>
 * <li>If the argument is NaN or infinite, then the result is
 * {@link java.lang.Double#MAX_EXPONENT Double#MAX_EXPONENT} + 1.
 * <li>If the argument is zero or subnormal, then the result is
 * {@link java.lang.Double#MIN_EXPONENT Double#MIN_EXPONENT} -1.
 * </ul>
 ...
 *
 * <li> If {@code start} is
 * &plusmn;{@link java.lang.Double#MIN_VALUE Double#MIN_VALUE} and {@code direction}
 ...
 * have a smaller magnitude, {@link java.lang.Double#MAX_VALUE Double#MAX_VALUE} with the
 * same sign as {@code start} is returned.
 *
 * <li> If {@code start} is equal to &plusmn;
 * {@link java.lang.Double#MAX_VALUE Double#MAX_VALUE} and {@code direction} has a
 ...
 *
 * <li> If {@code start} is
 * &plusmn;{@link java.lang.Float#MIN_VALUE Float#MIN_VALUE} and {@code direction}
 * has a value such that the result should have a smaller
 * magnitude, then a zero with the same sign as {@code start}
 * is returned.
 *
 * <li> If {@code start} is infinite and
 * {@code direction} has a value such that the result should
 * have a smaller magnitude, {@link java.lang.Float#MAX_VALUE Float#MAX_VALUE} with the
 * same sign as {@code start} is returned.
 *
 * <li> If {@code start} is equal to &plusmn;
 * {@link java.lang.Float#MAX_VALUE Float#MAX_VALUE} and {@code direction} has a
 * value such that the result should have a larger magnitude, an
 * infinity with same sign as {@code start} is returned.
 * </ul>
 *
 ...
 * {@link java.lang.Double#MIN_VALUE Double#MIN_VALUE}
 *
 * </ul>
 *
 ...
 *
 * <li> If the argument is zero, the result is
 * {@link java.lang.Float#MIN_VALUE Float#MIN_VALUE}
 *
 * </ul>
 *
