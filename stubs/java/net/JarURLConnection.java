 ...
 * @param url the URL
 * @throws java.net.MalformedURLException if no legal protocol
 * could be found in a specification string or the
 * string could not be parsed.
 * @apiSince 1
 */

protected JarURLConnection(java.net.URL url) throws java.net.MalformedURLException { super(null); throw new RuntimeException("Stub!"); }
 ...
 * returned
 *
 * @exception java.io.IOException if an IOException occurs while trying to
 ...
 * for this connection.
 *
 * @exception java.io.IOException if getting the JAR file for this
 ...
 * for it points to a JAR file entry, null otherwise.
 *
 * @exception java.io.IOException if getting the JAR entry causes an
 ...
 * connection.
 *
 * @exception java.io.IOException if getting the manifest causes an
 * IOException to be thrown.
 *
 * @see #getJarFile
 * @see #getManifest
