 ...
 * @throws java.lang.IllegalArgumentException if the proxy is of an invalid type
 *          or {@code null}.
 ...
 *
 * @exception java.net.SocketException if there is an error in the underlying protocol,
 * such as a TCP error.
 * @since   JDK1.1
 * @apiSince 1
 */
 ...
 *
 * @exception  java.net.UnknownHostException if the IP address of
 * the host could not be determined.
 *
 * @exception  java.io.IOException  if an I/O error occurs when creating the socket.
 ...
 *             the specified range of valid port values, which is between
 *             0 and 65535, inclusive.
 * @exception  java.lang.NullPointerException if {@code address} is null.
 * @see        java.net.Socket#setSocketImplFactory(java.net.SocketImplFactory)
 * @see        java.net.SocketImpl
 * @see        java.net.SocketImplFactory#createSocketImpl()
 * @see        SecurityManager#checkConnect
 ...
 * @exception  java.lang.IllegalArgumentException if the port parameter or localPort
 ...
 *             the specified range of valid port values, which is between
 *             0 and 65535, inclusive.
 * @exception  java.lang.NullPointerException if {@code host} is null.
 * @see        java.net.Socket#setSocketImplFactory(java.net.SocketImplFactory)
 * @see        java.net.SocketImpl
 * @see        java.net.SocketImplFactory#createSocketImpl()
 * @see        SecurityManager#checkConnect
 ...
 * @throws  java.lang.IllegalArgumentException if endpoint is null or is a
 ...
 *                     is already bound.
 * @throws  java.lang.IllegalArgumentException if bindpoint is a
 *          SocketAddress subclass not supported by this socket
 ...
 * @exception java.net.SocketException if there is an error
 * in the underlying protocol, such as a TCP error.
 * @exception java.lang.IllegalArgumentException if the linger value is negative.
 * @since JDK1.1
 * @see #getSoLinger()
 * @apiSince 1
 */
 ...
 * {@link java.net.ServerSocket#setReceiveBufferSize(int) ServerSocket#setReceiveBufferSize(int)} before the ServerSocket
