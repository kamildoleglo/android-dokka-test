 ...
 * @throws java.net.SocketException if the option is unrecognized,
 * the socket is closed, or some low-level error occurred
 * @see #getOption(int)
 * @apiSince 1
 */
 ...
 * @throws java.net.SocketException if <I>optID</I> is unknown along the
 ...
 * @see java.net.MulticastSocket#setNetworkInterface(NetworkInterface)
