 ...
 * {@link java.net.URI#toURL() URI#toURL()}.
 * <p>
 * The {@link java.net.URLEncoder URLEncoder} and {@link java.net.URLDecoder URLDecoder} classes can also be
 ...
 * @exception  java.net.MalformedURLException  if an unknown protocol is specified.
 ...
 * @exception  java.net.MalformedURLException  if no protocol is specified, or an
 ...
 * @exception  java.io.IOException  if an I/O exception occurs.
 * @exception  java.lang.SecurityException if a security manager is present
 *             and the caller doesn't have permission to connect
 *             to the proxy.
 * @exception  java.lang.IllegalArgumentException will be thrown if proxy is null,
 ...
 * @exception  java.lang.Error  if the application has already set a factory.
