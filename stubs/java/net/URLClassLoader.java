 ...
 * @exception  java.lang.NullPointerException if {@code urls} is {@code null}.
 ...
 * by catching {@link java.io.IOException IOException}s internally. Unchecked exceptions
 * and errors are not caught. Calling close on an already closed
 * loader has no effect.
 * <p>
 * @exception java.io.IOException if closing any file opened by this class loader
 * resulted in an IOException. Any such exceptions are caught internally.
 * If only one is caught, then it is re-thrown. If more than one exception
 * is caught, then the second and following exceptions are added
 * as suppressed exceptions of the first one caught, which is then re-thrown.
 *
 * @exception java.lang.SecurityException if a security manager is set, and it denies
 *   {@link java.lang.RuntimePermission RuntimePermission}{@code ("closeClassLoader")}
 *
 * @since 1.7
 * @apiSince 24
 */
 ...
 * @exception java.lang.NullPointerException if {@code name} is {@code null}.
 * @apiSince 1
 */
 ...
 * @exception   java.lang.IllegalArgumentException if the package name duplicates
 ...
 * @exception java.lang.NullPointerException if {@code codesource} is {@code null}.
