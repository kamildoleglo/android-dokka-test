 ...
 *
 *
 * <p> This class implements the {@link java.lang.CharSequence CharSequence} interface so that
 ...
 * chars are transferred and a {@link java.nio.BufferUnderflowException BufferUnderflowException} is
 * thrown.
 *
 ...
 * then no chars are transferred and a {@link java.nio.BufferOverflowException BufferOverflowException} is thrown.
 *
 ...
 * <tt>length</tt>&nbsp;<tt>&gt;</tt>&nbsp;<tt>remaining()</tt>, then no
 * chars are transferred and a {@link java.nio.BufferOverflowException BufferOverflowException} is
 * thrown.
 *
 ...
 * {@link java.lang.Character#compare(char,char) Character#compare(char,char)}.
