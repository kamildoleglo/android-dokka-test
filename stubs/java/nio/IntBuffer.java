 ...
 * ints are transferred and a {@link java.nio.BufferUnderflowException BufferUnderflowException} is
 * thrown.
 *
 ...
 * then no ints are transferred and a {@link java.nio.BufferOverflowException BufferOverflowException} is thrown.
 *
 ...
 * <tt>length</tt>&nbsp;<tt>&gt;</tt>&nbsp;<tt>remaining()</tt>, then no
 * ints are transferred and a {@link java.nio.BufferOverflowException BufferOverflowException} is
 * thrown.
 *
 ...
 * {@link java.lang.Integer#compare(int,int) Integer#compare(int,int)}.
