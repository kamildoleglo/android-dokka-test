 ...
 * shorts are transferred and a {@link java.nio.BufferUnderflowException BufferUnderflowException} is
 * thrown.
 *
 ...
 * then no shorts are transferred and a {@link java.nio.BufferOverflowException BufferOverflowException} is thrown.
 *
 ...
 * <tt>length</tt>&nbsp;<tt>&gt;</tt>&nbsp;<tt>remaining()</tt>, then no
 * shorts are transferred and a {@link java.nio.BufferOverflowException BufferOverflowException} is
 * thrown.
 *
 ...
 * {@link java.lang.Short#compare(short,short) Short#compare(short,short)}.
 ...
 * wrapping an existing <tt>short</tt> array is the {@link java.nio.ByteOrder#nativeOrder ByteOrder#nativeOrder} of the underlying
