 ...
 * operation has completed then a {@link java.nio.channels.ReadPendingException ReadPendingException} will be thrown.
 * Similarly, if a write method is invoked before a previous write has completed
 * then {@link java.nio.channels.WritePendingException WritePendingException} is thrown. Whether or not other kinds of
 ...
 * @see java.nio.channels.Channels#newOutputStream(AsynchronousByteChannel)
 *
 * @since 1.7
 * @apiSince 26
 */
 ...
 * completed then a {@link java.nio.channels.ReadPendingException ReadPendingException} will be thrown.
 *
 * @param   <A>
 ...
 * completed then a {@link java.nio.channels.WritePendingException WritePendingException} will be thrown.
 *
 * @param   <A>
 *          The type of the attachment
 * @param   src
