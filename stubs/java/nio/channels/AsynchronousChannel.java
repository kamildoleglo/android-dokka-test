 ...
 *
 * <ol>
 * <li><pre>{@link java.util.concurrent.Future Future}&lt;V&gt; <em>operation</em>(<em>...</em>)</pre></li>
 * <li><pre>void <em>operation</em>(<em>...</em> A attachment, {@link java.nio.channels.CompletionHandler CompletionHandler}&lt;V,? super A&gt; handler)</pre></li>
 * </ol>
 *
 ...
 *
 * <p> In the first form, the methods defined by the {@link java.util.concurrent.Future Future}
 * interface may be used to check if the operation has completed, wait for its
 * completion, and to retrieve the result. In the second form, a {@link java.nio.channels.CompletionHandler CompletionHandler} is invoked to consume the result of the I/O operation when
 ...
 * fails with the exception {@link java.nio.channels.AsynchronousCloseException AsynchronousCloseException}.
 *
 ...
 * exception {@link java.nio.channels.AsynchronousCloseException AsynchronousCloseException}.
 *
 ...
 * complete with the exception {@link java.nio.channels.AsynchronousCloseException AsynchronousCloseException}. After a
 * channel is closed, further attempts to initiate asynchronous I/O
 * operations complete immediately with cause {@link java.nio.channels.ClosedChannelException ClosedChannelException}.
 *
