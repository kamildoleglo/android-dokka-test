 ...
 * write method that initiates asynchronous operations. A {@link java.nio.channels.CompletionHandler CompletionHandler}
 * is specified as a parameter and is invoked to consume the result of the I/O
 * operation. This class also defines read and write methods that initiate
 * asynchronous operations, returning a {@link java.util.concurrent.Future Future} to represent the pending
 ...
 *
 * <p> As with {@link java.nio.channels.FileChannel FileChannel}, the view of a file provided by an instance of
 ...
 *
 * <p> The {@code executor} parameter is the {@link java.util.concurrent.ExecutorService ExecutorService} to
 ...
 * invocation
 * <pre>
 *     ch.{@link #open(java.nio.file.Path,java.util.Set,java.util.concurrent.ExecutorService,java.nio.file.attribute.FileAttribute[])
 ...
 * {@link #lock(java.lang.Object,java.nio.channels.CompletionHandler)} method simply locks a region
 * of size {@link java.lang.Long#MAX_VALUE Long#MAX_VALUE}. If a lock that overlaps the requested
 ...
 * completed, then this method throws {@link java.nio.channels.OverlappingFileLockException OverlappingFileLockException}.
 *
 ...
 * <pre>
 *     ch.{@link #lock(long,long,boolean,java.lang.Object,java.nio.channels.CompletionHandler) lock}(0L, Long.MAX_VALUE, false, att, handler)
 * </pre>
 *
 * @param   <A>
 *          The type of the attachment
