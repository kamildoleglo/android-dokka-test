...
protected FileLock(java.nio.channels.AsynchronousFileChannel channel, long position, long size, boolean shared) { throw new RuntimeException("Stub!"); }
...
public final boolean overlaps(long position, long size) { throw new RuntimeException("Stub!"); }
