...
protected MembershipKey() { throw new RuntimeException("Stub!"); }
...
public abstract java.nio.channels.MembershipKey block(java.net.InetAddress source) throws java.io.IOException;

/**
 * Unblock multicast datagrams from the given source address that was
 * previously blocked using the {@link #block(java.net.InetAddress) block} method.
 *
 * @param   source
