 ...
 * channel will cause a {@link java.nio.channels.NotYetConnectedException NotYetConnectedException} to be thrown.  A
 ...
 * to the asynchronous close operation specified in the {@link java.nio.channels.Channel Channel} class.
 ...
 * channel, then the blocked thread will receive an {@link java.nio.channels.AsynchronousCloseException AsynchronousCloseException}.
 *
...
public abstract class SocketChannel extends java.nio.channels.spi.AbstractSelectableChannel implements java.nio.channels.ByteChannel, java.nio.channels.ScatteringByteChannel, java.nio.channels.GatheringByteChannel, java.nio.channels.NetworkChannel {
...
protected SocketChannel(java.nio.channels.spi.SelectorProvider provider) { super(null); throw new RuntimeException("Stub!"); }
 ...
 * method, invoking the {@link #connect(java.net.SocketAddress) connect} method upon
