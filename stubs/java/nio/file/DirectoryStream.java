 ...
 * throw {@link java.nio.file.DirectoryIteratorException DirectoryIteratorException} with the {@link java.io.IOException IOException} as the
 ...
 * parameter to the {@link java.nio.file.Files#newDirectoryStream(java.nio.file.Path,java.nio.file.DirectoryStream.Filter) Files#newDirectoryStream(Path,DirectoryStream.Filter)}
...
public boolean accept(T entry) throws java.io.IOException;
}
