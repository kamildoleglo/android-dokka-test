 ...
 *     <em>path string</em>, returning a {@link java.nio.file.Path Path} object that may be used
 ...
 *     {@link java.nio.file.WatchService WatchService} that may be used to watch objects for changes and
 *     events. </p></li>
 * </ul>
 *
 ...
 * by means of an object associated with a read-only file system throws {@link java.nio.file.ReadOnlyFileSystemException ReadOnlyFileSystemException}.
 *
 ...
 * with this file system, throw {@link java.nio.file.ClosedFileSystemException ClosedFileSystemException}. If the
 ...
 * installed, the security manager is invoked to check {@link java.lang.RuntimePermission RuntimePermission}<tt>("getFileStoreAttributes")</tt>. If denied, then
 * no file stores are returned by the iterator. In addition, the security
 * manager's {@link java.lang.SecurityManager#checkRead(java.lang.String) SecurityManager#checkRead(String)} method is invoked to
 ...
 * and {@link java.nio.file.InvalidPathException InvalidPathException} thrown, if the path string contains
 ...
 * {@code String} representation of {@link java.nio.file.Path Path} objects by interpreting a
 * given pattern.
 *
 ...
 *   The {@link java.nio.file.Files#isHidden Files#isHidden} method may be used to test whether a file
...
/**
 * Constructs a new {@link java.nio.file.WatchService WatchService} <i>(optional operation)</i>.
 *
