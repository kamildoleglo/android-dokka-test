 ...
 *
 * @throws  java.nio.file.ClosedDirectoryStreamException
...
public java.nio.file.SecureDirectoryStream<T> newDirectoryStream(T path, java.nio.file.LinkOption... options) throws java.io.IOException;
...
public java.nio.channels.SeekableByteChannel newByteChannel(T path, java.util.Set<? extends java.nio.file.OpenOption> options, java.nio.file.attribute.FileAttribute<?>... attrs) throws java.io.IOException;
...
public void deleteFile(T path) throws java.io.IOException;
...
public void deleteDirectory(T path) throws java.io.IOException;
...
public void move(T srcpath, java.nio.file.SecureDirectoryStream<T> targetdir, T targetpath) throws java.io.IOException;
 ...
 * type if supported. Invoking this method to obtain a {@link java.nio.file.attribute.BasicFileAttributeView BasicFileAttributeView} always returns an instance of that class that is
 ...
 * then all methods to read or update attributes will throw {@link java.nio.file.ClosedDirectoryStreamException ClosedDirectoryStreamException}.
 *
 * @param   <V>
 ...
 * then all methods to read or update attributes will throw {@link java.nio.file.ClosedDirectoryStreamException ClosedDirectoryStreamException}. The
...
public <V extends java.nio.file.attribute.FileAttributeView> V getFileAttributeView(T path, java.lang.Class<V> type, java.nio.file.LinkOption... options);
}
