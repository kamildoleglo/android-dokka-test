...
/**
 * An object to lookup user and group principals by name. A {@link java.nio.file.attribute.UserPrincipal UserPrincipal}
 * represents an identity that may be used to determine access rights to objects
 * in a file system. A {@link java.nio.file.attribute.GroupPrincipal GroupPrincipal} represents a <em>group identity</em>.
 ...
 *
 * @throws  java.nio.file.attribute.UserPrincipalNotFoundException
 *          the principal does not exist
 * @throws  java.io.IOException
 *          if an I/O error occurs
 * @throws  java.lang.SecurityException
 *          In the case of the default provider, and a security manager is
 *          installed, it checks {@link java.lang.RuntimePermission RuntimePermission}<tt>("lookupUserInformation")</tt>
 * @apiSince 26
 */

public abstract java.nio.file.attribute.UserPrincipal lookupPrincipalByName(java.lang.String name) throws java.io.IOException;

/**
 * Lookup a group principal by group name.
 *
 * <p> Where an implementation does not support any notion of group then
 * this method always throws {@link java.nio.file.attribute.UserPrincipalNotFoundException UserPrincipalNotFoundException}. Where
...
public abstract java.nio.file.attribute.GroupPrincipal lookupPrincipalByGroupName(java.lang.String group) throws java.io.IOException;
}
