 ...
 * is identified by the URI scheme "file". It creates the {@link java.nio.file.FileSystem FileSystem} that
 * provides access to the file systems accessible to the Java virtual machine.
 * The {@link java.nio.file.FileSystems FileSystems} class defines how file system providers are located
 ...
 *
 * <p> A provider is a factory for one or more {@link java.nio.file.FileSystem FileSystem} instances. Each
 ...
 *          {@link java.lang.RuntimePermission RuntimePermission}<tt>("fileSystemProvider")</tt>
 * @apiSince 26
 */
 ...
 * providers as described by the {@link java.nio.file.FileSystems FileSystems} class.
 *
 ...
 * method is invoked by the {@link java.nio.file.FileSystems#newFileSystem(java.net.URI,java.util.Map) FileSystems#newFileSystem(URI,Map)}
 ...
 * the file system.
 *
 * <p> This method throws {@link java.nio.file.FileSystemAlreadyExistsException FileSystemAlreadyExistsException} if the
 ...
 * created by invoking the {@link #newFileSystem(java.net.URI,java.util.Map) newFileSystem(URI,Map)}
 * method. File systems created the {@link #newFileSystem(java.nio.file.Path,java.util.Map)
 ...
 * method returns a reference to the closed file system or throws {@link java.nio.file.FileSystemNotFoundException FileSystemNotFoundException}. If the provider allows a new file system to
...
/**
 * Return a {@code Path} object by converting the given {@link java.net.URI URI}. The
 * resulting {@code Path} is associated with a {@link java.nio.file.FileSystem FileSystem} that
 ...
 * default {@link java.nio.file.FileSystems#getDefault FileSystems#getDefault} {@code FileSystem}.
 *
 * <p> If a security manager is installed then a provider implementation
 * may require to check a permission. In the case of the {@link java.nio.file.FileSystems#getDefault FileSystems#getDefault} file system, no permission check is
 * required.
 *
 * @param   uri
 *          The URI to convert
 ...
 * method works in exactly the manner specified by the {@link java.nio.file.Files#newInputStream Files#newInputStream} method.
 *
 ...
 * specified by the {@link java.nio.file.Files#newOutputStream Files#newOutputStream} method.
 *
 * <p> The default implementation of this method opens a channel to the file
 * as if by invoking the {@link #newByteChannel} method and constructs a
 ...
 * specified by the {@link java.nio.channels.FileChannel#open(java.nio.file.Path,java.util.Set,java.nio.file.attribute.FileAttribute[]) FileChannel#open(Path,Set,FileAttribute[])} method. A provider that does not support all the
 ...
 *          If an I/O error occurs
 * @throws  java.lang.SecurityException
 *          In the case of the default file system, the {@link java.lang.SecurityManager#checkRead(java.lang.String) SecurityManager#checkRead(String)} method is invoked to check
 ...
 * exactly the manner specified by the {@link java.nio.channels.AsynchronousFileChannel#open(java.nio.file.Path,java.util.Set,java.util.concurrent.ExecutorService,java.nio.file.attribute.FileAttribute[]) AsynchronousFileChannel#open(Path,Set,ExecutorService,FileAttribute[])} method.
 ...
 * file. This method works in exactly the manner specified by the {@link java.nio.file.Files#newByteChannel(java.nio.file.Path,java.util.Set,java.nio.file.attribute.FileAttribute[]) Files#newByteChannel(Path,Set,FileAttribute[])} method.
 *
 * @param   path
 *          the path to the file to open or create
 * @param   options
 ...
 * specified by the {@link java.nio.file.Files#newDirectoryStream(java.nio.file.Path,java.nio.file.DirectoryStream.Filter) Files#newDirectoryStream(java.nio.file.Path, java.nio.file.DirectoryStream.Filter)}
 * method.
 *
 * @param   dir
 ...
 * specified by the {@link java.nio.file.Files#createDirectory Files#createDirectory} method.
 *
 * @param   dir
 ...
 * manner specified by the {@link java.nio.file.Files#createSymbolicLink Files#createSymbolicLink} method.
 *
 ...
 * works in exactly the manner specified by the {@link java.nio.file.Files#createLink Files#createLink}
 * method.
 *
 * <p> The default implementation of this method throws {@code
 * UnsupportedOperationException}.
 ...
 * {@link java.nio.file.Files#delete Files#delete} method.
 *
 * @param   path
 ...
 * specified by the {@link java.nio.file.Files#deleteIfExists Files#deleteIfExists} method.
 *
 ...
 * manner specified by the {@link java.nio.file.Files#readSymbolicLink Files#readSymbolicLink} method.
 *
 * <p> The default implementation of this method throws {@code
 * UnsupportedOperationException}.
 *
 ...
 * specified by the {@link java.nio.file.Files#copy(java.nio.file.Path,java.nio.file.Path,java.nio.file.CopyOption[]) Files#copy(Path,Path,CopyOption[])} method
 ...
 * manner specified by the {@link java.nio.file.Files#move Files#move} method except that both the
 ...
 * manner specified by the {@link java.nio.file.Files#isSameFile Files#isSameFile} method.
 *
 * @param   path
 ...
 * works in exactly the manner specified by the {@link java.nio.file.Files#isHidden Files#isHidden}
 * method.
 *
 * <p> This method is invoked by the {@link java.nio.file.Files#isHidden Files#isHidden} method.
 *
 * @param   path
 ...
 * {@link java.nio.file.Files#getFileStore Files#getFileStore} method.
 *
 * @param   path
 *          the path to the file
 *
 ...
 *
 * <p> This method may be used by the {@link java.nio.file.Files#isReadable Files#isReadable},
 * {@link java.nio.file.Files#isWritable Files#isWritable} and {@link java.nio.file.Files#isExecutable Files#isExecutable} methods to check the accessibility of a file.
 *
 ...
 * <tr>
 *   <td> {@link java.nio.file.AccessMode#READ AccessMode#READ} </td>
 *   <td> Checks that the file exists and that the Java virtual machine has
 *     permission to read the file. </td>
 * </tr>
 * <tr>
 *   <td> {@link java.nio.file.AccessMode#WRITE AccessMode#WRITE} </td>
 *   <td> Checks that the file exists and that the Java virtual machine has
 *     permission to write to the file, </td>
 * </tr>
 * <tr>
 *   <td> {@link java.nio.file.AccessMode#EXECUTE AccessMode#EXECUTE} </td>
 *   <td> Checks that the file exists and that the Java virtual machine has
 *     permission to {@link java.lang.Runtime#exec Runtime#exec} the file. The semantics
 ...
 *          existence of the file, the {@link java.lang.SecurityManager#checkWrite(java.lang.String) SecurityManager#checkWrite(String)} is invoked when checking write access to the file,
 *          and {@link java.lang.SecurityManager#checkExec(java.lang.String) SecurityManager#checkExec(String)} is invoked
 ...
 * exactly the manner specified by the {@link java.nio.file.Files#getFileAttributeView Files#getFileAttributeView}
 * method.
 *
 * @param   <V>
 ...
 * exactly the manner specified by the {@link java.nio.file.Files#readAttributes(java.nio.file.Path,java.lang.Class,java.nio.file.LinkOption[]) Files#readAttributes(Path,Class,LinkOption[])} method.
 *
 * @param   <A>
 ...
 * exactly the manner specified by the {@link java.nio.file.Files#readAttributes(java.nio.file.Path,java.lang.String,java.nio.file.LinkOption[]) Files#readAttributes(Path,String,LinkOption[])} method.
 *
 * @param   path
 *          the path to the file
 * @param   attributes
 ...
 * manner specified by the {@link java.nio.file.Files#setAttribute Files#setAttribute} method.
 *
 * @param   path
 *          the path to the file
 * @param   attribute
