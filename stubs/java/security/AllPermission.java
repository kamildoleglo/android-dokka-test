...
public AllPermission() { super(null); throw new RuntimeException("Stub!"); }

/** @apiSince 1 */

public AllPermission(java.lang.String name, java.lang.String actions) { super(null); throw new RuntimeException("Stub!"); }
