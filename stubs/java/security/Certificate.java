 ...
 * certificate.
 *
 * @exception java.security.KeyException if the certificate is not
 * properly initialized, or data is missing, etc.
 *
 * @exception java.io.IOException if a stream exception occurs while
...
@Deprecated
public void encode(java.io.OutputStream stream) throws java.io.IOException, java.security.KeyException;
 ...
 * being decoded.
 *
 * @exception java.security.KeyException if the certificate is not properly initialized,
 * or data is missing, etc.
 *
 * @exception java.io.IOException if an exception occurs while trying to input
...
@Deprecated
public void decode(java.io.InputStream stream) throws java.io.IOException, java.security.KeyException;
