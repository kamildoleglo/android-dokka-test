 ...
 * See {@link java.util.Arrays#toString(java.lang.Object[]) Arrays#toString(java.lang.Object[])}.
 * <p>
 ...
 *
 * @exception java.lang.NullPointerException if {@code configuration} or
 *     {@code protectionParams} is {@code null}
 * @apiSince 26
 */

public DomainLoadStoreParameter(java.net.URI configuration, java.util.Map<java.lang.String,java.security.KeyStore.ProtectionParameter> protectionParams) { throw new RuntimeException("Stub!"); }
...
public java.net.URI getConfiguration() { throw new RuntimeException("Stub!"); }
...
public java.util.Map<java.lang.String,java.security.KeyStore.ProtectionParameter> getProtectionParams() { throw new RuntimeException("Stub!"); }
...
public java.security.KeyStore.ProtectionParameter getProtectionParameter() { throw new RuntimeException("Stub!"); }
}
