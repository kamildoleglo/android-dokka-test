 ...
 *
 * @exception java.security.KeyStoreException if the given key cannot be protected, or
 ...
 * {@code java.security.PrivateKey}).
 *
 * @exception java.security.KeyStoreException if this operation fails.
 * @apiSince 1
 */
 ...
 *
 * @exception java.security.KeyStoreException if the given alias already exists and does
 ...
 * @param alias the alias name
 *
 * @exception java.security.KeyStoreException if the entry cannot be removed.
 * @apiSince 1
 */
 ...
 *
 * @exception java.security.KeyStoreException if the operation failed
 * @exception java.security.NoSuchAlgorithmException if the algorithm for recovering the
