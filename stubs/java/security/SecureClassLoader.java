 ...
 * @exception  java.lang.ClassFormatError if the data did not contain a valid class
 * @exception  java.lang.IndexOutOfBoundsException if either {@code off} or
 *             {@code len} is negative, or if
 *             {@code off+len} is greater than {@code b.length}.
 *
 * @exception  java.lang.SecurityException if an attempt is made to add this class
