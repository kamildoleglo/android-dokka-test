 ...
 * {@link java.security.cert.CertPath.CertPathRep CertPathRep} object during serialization. This allows
 ...
 * certificate representing the {@link java.security.cert.TrustAnchor TrustAnchor} should not be
 ...
 * @return the encoded bytes
 * @exception java.security.cert.CertificateEncodingException if an encoding error occurs or
 ...
 *
 * @throws java.io.ObjectStreamException if a {@code CertPathRep} object
 ...
 *
 * @throws java.io.ObjectStreamException if a {@code CertPath} could not
 * be constructed
 * @apiSince 1
 */
