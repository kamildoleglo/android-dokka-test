 ...
 * @throws java.lang.IllegalArgumentException if the name constraints cannot be
 * decoded
 ...
 * documentation for
 * {@link #TrustAnchor(java.security.cert.X509Certificate,byte[])
 ...
 * Only the value of the extension is included, not the OID or criticality
 * flag. Specify {@code null} to omit the parameter.
 * @throws java.lang.NullPointerException if the specified {@code caPrincipal} or
 * {@code pubKey} parameter is {@code null}
 * @since 1.5
 * @apiSince 1
 */

public TrustAnchor(javax.security.auth.x500.X500Principal caPrincipal, java.security.PublicKey pubKey, byte[] nameConstraints) { throw new RuntimeException("Stub!"); }
 ...
 * @throws java.lang.NullPointerException if the specified {@code caName} or
 * {@code pubKey} parameter is {@code null}
 * @apiSince 1
 */

public TrustAnchor(java.lang.String caName, java.security.PublicKey pubKey, byte[] nameConstraints) { throw new RuntimeException("Stub!"); }
