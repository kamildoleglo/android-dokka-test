...
protected X509Certificate() { super(null); throw new RuntimeException("Stub!"); }
 ...
 * </pre>
 *
 * @exception java.security.cert.CertificateExpiredException if the certificate has expired.
 * @exception java.security.cert.CertificateNotYetValidException if the certificate is not
 * yet valid.
 * @apiSince 1
 */
