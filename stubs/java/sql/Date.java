 ...
 *         given date
 * @throws java.lang.IllegalArgumentException if the date given is not in the
...
@Deprecated
public void setHours(int i) { throw new RuntimeException("Stub!"); }
...
@Deprecated
public void setMinutes(int i) { throw new RuntimeException("Stub!"); }
...
@Deprecated
public void setSeconds(int i) { throw new RuntimeException("Stub!"); }
}
