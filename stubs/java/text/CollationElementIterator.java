...
public static int primaryOrder(int order) { throw new RuntimeException("Stub!"); }
...
public static short secondaryOrder(int order) { throw new RuntimeException("Stub!"); }
...
public static short tertiaryOrder(int order) { throw new RuntimeException("Stub!"); }
...
public int getMaxExpansion(int order) { throw new RuntimeException("Stub!"); }
