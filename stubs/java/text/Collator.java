 ...
 * for {@link java.text.CollationKey CollationKey}
...
public static synchronized java.text.Collator getInstance() { throw new RuntimeException("Stub!"); }
...
public static java.text.Collator getInstance(java.util.Locale desiredLocale) { throw new RuntimeException("Stub!"); }
 ...
 *         second.
 * @exception java.lang.ClassCastException the arguments cannot be cast to Strings.
...
public synchronized int getStrength() { throw new RuntimeException("Stub!"); }
 ...
 * @see java.text.Collator#TERTIARY
 * @see java.text.Collator#IDENTICAL
 * @exception  java.lang.IllegalArgumentException If the new strength value is not one of
 * PRIMARY, SECONDARY, TERTIARY or IDENTICAL.
 * @apiSince 1
 */

public synchronized void setStrength(int newStrength) { throw new RuntimeException("Stub!"); }
...
public synchronized int getDecomposition() { throw new RuntimeException("Stub!"); }
 ...
 * @see java.text.Collator#CANONICAL_DECOMPOSITION
 * @see java.text.Collator#FULL_DECOMPOSITION
 * @exception java.lang.IllegalArgumentException If the given value is not a valid decomposition
 * mode.
 * @apiSince 1
 */

public synchronized void setDecomposition(int decompositionMode) { throw new RuntimeException("Stub!"); }
