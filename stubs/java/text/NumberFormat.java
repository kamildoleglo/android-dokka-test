 ...
 * @exception        java.lang.IllegalArgumentException if <code>number</code> is
 *                   null or not an instance of <code>Number</code>.
 * @exception        java.lang.NullPointerException if <code>toAppendTo</code> or
 *                   <code>pos</code> is null
 * @exception        java.lang.ArithmeticException if rounding is needed with rounding
...
public java.lang.StringBuffer format(@androidx.annotation.NonNull java.lang.Object number, @androidx.annotation.NonNull java.lang.StringBuffer toAppendTo, @androidx.annotation.NonNull java.text.FieldPosition pos) { throw new RuntimeException("Stub!"); }
...
public final java.lang.Object parseObject(@androidx.annotation.NonNull java.lang.String source, @androidx.annotation.NonNull java.text.ParsePosition pos) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.NonNull
public abstract java.lang.StringBuffer format(double number, @androidx.annotation.NonNull java.lang.StringBuffer toAppendTo, @androidx.annotation.NonNull java.text.FieldPosition pos);
...
@androidx.annotation.NonNull
public abstract java.lang.StringBuffer format(long number, @androidx.annotation.NonNull java.lang.StringBuffer toAppendTo, @androidx.annotation.NonNull java.text.FieldPosition pos);
...
@androidx.annotation.Nullable
public abstract java.lang.Number parse(@androidx.annotation.NonNull java.lang.String source, @androidx.annotation.NonNull java.text.ParsePosition parsePosition);
...
@androidx.annotation.Nullable
public java.lang.Number parse(@androidx.annotation.NonNull java.lang.String source) throws java.text.ParseException { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.NonNull
public static java.text.NumberFormat getInstance(@androidx.annotation.NonNull java.util.Locale inLocale) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.NonNull
public static java.text.NumberFormat getNumberInstance(@androidx.annotation.NonNull java.util.Locale inLocale) { throw new RuntimeException("Stub!"); }
 ...
 * <p>This is equivalent to calling
 * {@link #getIntegerInstance(java.util.Locale)
...
@androidx.annotation.NonNull
public static java.text.NumberFormat getIntegerInstance(@androidx.annotation.NonNull java.util.Locale inLocale) { throw new RuntimeException("Stub!"); }

/**
 * Returns a currency format for the current default
 * {@link java.util.Locale.Category#FORMAT FORMAT} locale.
 * <p>This is equivalent to calling
 * {@link #getCurrencyInstance(java.util.Locale)
...
@androidx.annotation.NonNull
public static java.text.NumberFormat getCurrencyInstance(@androidx.annotation.NonNull java.util.Locale inLocale) { throw new RuntimeException("Stub!"); }

/**
 * Returns a percentage format for the current default
 * {@link java.util.Locale.Category#FORMAT FORMAT} locale.
 * <p>This is equivalent to calling
 * {@link #getPercentInstance(java.util.Locale)
...
@androidx.annotation.NonNull
public static java.text.NumberFormat getPercentInstance(@androidx.annotation.NonNull java.util.Locale inLocale) { throw new RuntimeException("Stub!"); }
 ...
 * @exception java.lang.UnsupportedOperationException if the number format class
...
public void setCurrency(@androidx.annotation.NonNull java.util.Currency currency) { throw new RuntimeException("Stub!"); }
 ...
 * this method.
 *
 * @exception java.lang.UnsupportedOperationException The default implementation
 ...
 * @exception java.lang.UnsupportedOperationException The default implementation
 *     always throws this exception
 * @exception java.lang.NullPointerException if <code>roundingMode</code> is null
...
public void setRoundingMode(@androidx.annotation.Nullable java.math.RoundingMode roundingMode) { throw new RuntimeException("Stub!"); }
...
protected Field(@androidx.annotation.NonNull java.lang.String name) { super(null); throw new RuntimeException("Stub!"); }
...
@androidx.annotation.NonNull public static final java.text.NumberFormat.Field CURRENCY;
...
@androidx.annotation.NonNull public static final java.text.NumberFormat.Field DECIMAL_SEPARATOR;
...
@androidx.annotation.NonNull public static final java.text.NumberFormat.Field EXPONENT;
...
@androidx.annotation.NonNull public static final java.text.NumberFormat.Field EXPONENT_SIGN;
...
@androidx.annotation.NonNull public static final java.text.NumberFormat.Field EXPONENT_SYMBOL;
...
@androidx.annotation.NonNull public static final java.text.NumberFormat.Field FRACTION;
...
@androidx.annotation.NonNull public static final java.text.NumberFormat.Field GROUPING_SEPARATOR;
...
@androidx.annotation.NonNull public static final java.text.NumberFormat.Field INTEGER;
static { INTEGER = null; }
...
@androidx.annotation.NonNull public static final java.text.NumberFormat.Field PERCENT;
static { PERCENT = null; }
...
@androidx.annotation.NonNull public static final java.text.NumberFormat.Field PERMILLE;
...
@androidx.annotation.NonNull public static final java.text.NumberFormat.Field SIGN;
static { SIGN = null; }
}
