 ...
 *
 * @implSpec
 * This implementation returns a set that subclasses {@link java.util.AbstractSet AbstractSet}.
 ...
 *
 * @implSpec
 * This implementation returns a collection that subclasses {@link java.util.AbstractCollection AbstractCollection}.  The subclass's iterator method returns a
...
public SimpleEntry(@androidx.annotation.NonNull java.util.Map.Entry<? extends K,? extends V> entry) { throw new RuntimeException("Stub!"); }
...
public SimpleImmutableEntry(@androidx.annotation.NonNull java.util.Map.Entry<? extends K,? extends V> entry) { throw new RuntimeException("Stub!"); }
