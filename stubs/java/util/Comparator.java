 ...
 * serializable data structures (like {@link java.util.TreeSet TreeSet}, {@link java.util.TreeMap TreeMap}).  In
 ...
 *         second.
 * @throws java.lang.NullPointerException if an argument is null and this
 ...
 * {@link java.lang.Object#equals(java.lang.Object) Object#equals(Object)}.  Additionally, this method can return
...
public default java.util.Comparator<T> reversed() { throw new RuntimeException("Stub!"); }
...
public default java.util.Comparator<T> thenComparing(java.util.Comparator<? super T> other) { throw new RuntimeException("Stub!"); }
...
public default <U> java.util.Comparator<T> thenComparing(java.util.function.Function<? super T,? extends U> keyExtractor, java.util.Comparator<? super U> keyComparator) { throw new RuntimeException("Stub!"); }
 ...
 *
 * @param  <U>  the type of the {@link java.lang.Comparable Comparable} sort key
 * @param  keyExtractor the function used to extract the {@link java.lang.Comparable Comparable} sort key
 * @return a lexicographic-order comparator composed of this and then the
 *         {@link java.lang.Comparable Comparable} sort key.
 * @throws java.lang.NullPointerException if the argument is null.
...
public default <U extends java.lang.Comparable<? super U>> java.util.Comparator<T> thenComparing(java.util.function.Function<? super T,? extends U> keyExtractor) { throw new RuntimeException("Stub!"); }
...
public default java.util.Comparator<T> thenComparingInt(java.util.function.ToIntFunction<? super T> keyExtractor) { throw new RuntimeException("Stub!"); }
...
public default java.util.Comparator<T> thenComparingLong(java.util.function.ToLongFunction<? super T> keyExtractor) { throw new RuntimeException("Stub!"); }
...
public default java.util.Comparator<T> thenComparingDouble(java.util.function.ToDoubleFunction<? super T> keyExtractor) { throw new RuntimeException("Stub!"); }

/**
 * Returns a comparator that imposes the reverse of the <em>natural
 * ordering</em>.
 *
 * <p>The returned comparator is serializable and throws {@link java.lang.NullPointerException NullPointerException} when comparing {@code null}.
 *
 * @param  <T> the {@link java.lang.Comparable Comparable} type of element to be compared
...
/**
 * Returns a comparator that compares {@link java.lang.Comparable Comparable} objects in natural
 * order.
 *
 * <p>The returned comparator is serializable and throws {@link java.lang.NullPointerException NullPointerException} when comparing {@code null}.
 *
