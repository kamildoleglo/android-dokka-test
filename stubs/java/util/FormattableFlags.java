...
private FormattableFlags() { throw new RuntimeException("Stub!"); }
...
public static final int ALTERNATE = 4; // 0x4
...
public static final int LEFT_JUSTIFY = 1; // 0x1
...
public static final int UPPERCASE = 2; // 0x2
}
