...
@androidx.annotation.NonNull
public <T> T[] toArray(@androidx.annotation.NonNull T[] a);
 ...
 * @throws java.lang.UnsupportedOperationException if the <tt>add</tt> operation
 ...
 *         list does not permit null elements
 * (<a href="Collection.html#optional-restrictions">optional</a>)
 * @throws java.lang.UnsupportedOperationException if the <tt>remove</tt> operation
 *         is not supported by this list
 * @apiSince 1
 */
...
public boolean containsAll(@androidx.annotation.NonNull java.util.Collection<?> c);
...
public boolean addAll(@androidx.annotation.NonNull java.util.Collection<? extends E> c);
...
public boolean addAll(int index, @androidx.annotation.NonNull java.util.Collection<? extends E> c);
 ...
 * @return <tt>true</tt> if this list changed as a result of the call
 * @throws java.lang.UnsupportedOperationException if the <tt>removeAll</tt> operation
 *         is not supported by this list
...
public boolean removeAll(@androidx.annotation.NonNull java.util.Collection<?> c);
 ...
 * @return <tt>true</tt> if this list changed as a result of the call
 * @throws java.lang.UnsupportedOperationException if the <tt>retainAll</tt> operation
 *         is not supported by this list
 * @throws java.lang.ClassCastException if the class of an element of this list
 *         is incompatible with the specified collection
 * (<a href="Collection.html#optional-restrictions">optional</a>)
...
public boolean retainAll(@androidx.annotation.NonNull java.util.Collection<?> c);
 ...
 * @throws java.lang.UnsupportedOperationException if this list is unmodifiable.
 *         Implementations may throw this exception if an element
 *         cannot be replaced or if, in general, modification is not
 *         supported
 * @throws java.lang.NullPointerException if the specified operator is null or
...
public default void replaceAll(@androidx.annotation.NonNull java.util.function.UnaryOperator<E> operator) { throw new RuntimeException("Stub!"); }
 ...
 * Nougat (API level {@code > 25}), {@link java.util.Collections#sort(java.util.List) Collections#sort(List)}
 * delegates to this method. Such apps must not call
 * {@link java.util.Collections#sort(java.util.List) Collections#sort(List)} from this method. Instead, prefer
 ...
 *         (<a href="Collection.html#optional-restrictions">optional</a>)
 *         if the comparator is found to violate the {@link java.util.Comparator Comparator}
 *         contract
 * @since 1.8
 * @apiSince 24
 */

public default void sort(@androidx.annotation.Nullable java.util.Comparator<? super E> c) { throw new RuntimeException("Stub!"); }

/**
 * Removes all of the elements from this list (optional operation).
 * The list will be empty after this call returns.
 *
 * @throws java.lang.UnsupportedOperationException if the <tt>clear</tt> operation
 *         is not supported by this list
 * @apiSince 1
 */
 ...
 * contract of {@link java.lang.Object#hashCode Object#hashCode}.
 *
 ...
 * @throws java.lang.UnsupportedOperationException if the <tt>set</tt> operation
 *         is not supported by this list
 * @throws java.lang.ClassCastException if the class of the specified element
 *         prevents it from being added to this list
...
public int indexOf(@androidx.annotation.Nullable java.lang.Object o);
...
public int lastIndexOf(@androidx.annotation.Nullable java.lang.Object o);
 ...
 * @throws java.lang.IndexOutOfBoundsException for an illegal endpoint index value
...
/**
 * Creates a {@link java.util.Spliterator Spliterator} over the elements in this list.
 *
 * <p>The {@code Spliterator} reports {@link java.util.Spliterator#SIZED Spliterator#SIZED} and
 * {@link java.util.Spliterator#ORDERED Spliterator#ORDERED}.  Implementations should document the
