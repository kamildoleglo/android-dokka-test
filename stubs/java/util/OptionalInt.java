...
private OptionalInt() { throw new RuntimeException("Stub!"); }
...
public static java.util.OptionalInt empty() { throw new RuntimeException("Stub!"); }
...
public static java.util.OptionalInt of(int value) { throw new RuntimeException("Stub!"); }
...
public int getAsInt() { throw new RuntimeException("Stub!"); }
...
public void ifPresent(java.util.function.IntConsumer consumer) { throw new RuntimeException("Stub!"); }
...
public int orElse(int other) { throw new RuntimeException("Stub!"); }
...
public int orElseGet(java.util.function.IntSupplier other) { throw new RuntimeException("Stub!"); }
...
public <X extends java.lang.Throwable> int orElseThrow(java.util.function.Supplier<X> exceptionSupplier) throws X { throw new RuntimeException("Stub!"); }
