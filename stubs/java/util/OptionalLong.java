...
private OptionalLong() { throw new RuntimeException("Stub!"); }
...
public <X extends java.lang.Throwable> long orElseThrow(java.util.function.Supplier<X> exceptionSupplier) throws X { throw new RuntimeException("Stub!"); }
