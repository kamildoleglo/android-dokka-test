 ...
 * @throws java.lang.NullPointerException if <code>stream</code> is null
 * @throws java.lang.IllegalArgumentException if {@code stream} contains a
 ...
 *        read from.
 * @throws java.io.IOException if an I/O error occurs
 * @throws java.lang.NullPointerException if <code>reader</code> is null
 * @throws java.lang.IllegalArgumentException if a malformed Unicode escape sequence appears
 *     from {@code reader}.
 * @since 1.6
 * @apiSince 9
 */

public PropertyResourceBundle(java.io.Reader reader) throws java.io.IOException { throw new RuntimeException("Stub!"); }
