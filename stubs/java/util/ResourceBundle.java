 ...
 *
 * The {@link java.util.ResourceBundle.Control ResourceBundle.Control} class provides information necessary
 ...
 * {@link #getBundle(java.lang.String,java.util.Locale,java.lang.ClassLoader,java.util.ResourceBundle.Control) getBundle}
 ...
 * @exception java.lang.NullPointerException if <code>key</code> is <code>null</code>
 * @exception java.util.MissingResourceException if no object for the given key can be found
 * @exception java.lang.ClassCastException if the object found for the given key is not a string
 ...
 * @exception java.lang.NullPointerException if <code>key</code> is <code>null</code>
 * @exception java.util.MissingResourceException if no object for the given key can be found
 * @exception java.lang.ClassCastException if the object found for the given key is not a string array
 ...
 * #getBundle(java.lang.String,java.util.Locale,java.lang.ClassLoader,java.util.ResourceBundle.Control) getBundle} for the
 ...
 * {@link #getBundle(java.lang.String,java.util.Locale,java.lang.ClassLoader,java.util.ResourceBundle.Control)} passing a
 * default instance of {@link java.util.ResourceBundle.Control Control}.
 *
 ...
 * finds a "resource", it attempts to create a new {@link java.util.PropertyResourceBundle PropertyResourceBundle} instance from its contents.  If successful, this
 ...
 * #getBundle(java.lang.String,java.util.Locale,java.lang.ClassLoader) <code>getBundle</code>
 ...
 * <li>Requested <code>Locale</code>: {@link java.util.Locale#ITALY Locale#ITALY}</li>
 * <li>Default <code>Locale</code>: {@link java.util.Locale#FRENCH Locale#FRENCH}</li>
 ...
 * @exception java.lang.NullPointerException if <code>loader</code> is null
 * @since 1.6
 * @see java.util.ResourceBundle.Control#getTimeToLive(String,Locale)
 * @apiSince 9
 */
 ...
 * for the ones for which the {@link #handleGetObject(java.lang.String)
 ...
 * #toBundleName(java.lang.String,java.util.Locale) toBundleName} and {@link
 * #toResourceName(java.lang.String,java.lang.String) toResourceName} methods are defined
 ...
 * </ol>
 *
 * <p>The default implementation uses an {@link java.util.ArrayList ArrayList} that
 ...
 * #toBundleName(java.lang.String,java.util.Locale) toBundleName(baseName,
 * locale)}.</li>
 *
 ...
 *        {@link #toBundleName(java.lang.String,java.util.Locale) toBundleName}
 * @exception java.lang.IllegalArgumentException
 ...
 *        instances is denied. See {@link java.lang.Class#newInstance() Class#newInstance()}
 *        for details.
 ...
 * #needsReload(java.lang.String,java.util.Locale,java.lang.String,java.lang.ClassLoader,java.util.ResourceBundle,long) needsReload} method to determine whether the resource
 ...
 * implementation of the {@link #newBundle(java.lang.String,java.util.Locale,java.lang.String,java.lang.ClassLoader,boolean) newBundle} and {@link #needsReload(java.lang.String,java.util.Locale,java.lang.String,java.lang.ClassLoader,java.util.ResourceBundle,long) needsReload}
 * methods.
 *
