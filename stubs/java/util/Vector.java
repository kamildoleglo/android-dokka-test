 ...
 * implement the {@link java.util.List List} interface, making it a member of the
 * <a href="https://docs.oracle.com/javase/8/docs/technotes/guides/collections/index.html">
 * Java Collections Framework</a>.  Unlike the new collection
 * implementations, {@code Vector} is synchronized.  If a thread-safe
 * implementation is not needed, it is recommended to use {@link java.util.ArrayList ArrayList} in place of {@code Vector}.
 *
 * @author  Lee Boynton
...
public Vector(@androidx.annotation.NonNull java.util.Collection<? extends E> c) { throw new RuntimeException("Stub!"); }
 ...
 * @throws java.lang.IndexOutOfBoundsException if the specified array is not
 *         large enough to hold all the components of this vector
 * @throws java.lang.ArrayStoreException if a component of this vector is not of
 *         a runtime type that can be stored in the specified array
 * @see #toArray(Object[])
 * @apiSince 1
 */

public synchronized void copyInto(@androidx.annotation.NonNull java.lang.Object[] anArray) { throw new RuntimeException("Stub!"); }
...
public synchronized int indexOf(@androidx.annotation.Nullable java.lang.Object o, int index) { throw new RuntimeException("Stub!"); }
...
public synchronized int lastIndexOf(@androidx.annotation.Nullable java.lang.Object o) { throw new RuntimeException("Stub!"); }
...
public synchronized int lastIndexOf(@androidx.annotation.Nullable java.lang.Object o, int index) { throw new RuntimeException("Stub!"); }

/**
 * Returns the component at the specified index.
 *
 * <p>This method is identical in functionality to the {@link #get(int)}
 * method (which is part of the {@link java.util.List List} interface).
 *
 * @param      index   an index into this vector
 * @return     the component at the specified index
 * @throws java.lang.ArrayIndexOutOfBoundsException if the index is out of range
 ...
 * method (which is part of the {@link java.util.List List} interface). Note that the
 ...
 *
 * <p>This method is identical in functionality to the
 * {@link #add(int,java.lang.Object) add(int, E)}
 * method (which is part of the {@link java.util.List List} interface).  Note that the
 ...
 *
 * <p>This method is identical in functionality to the
 * {@link #add(java.lang.Object) add(E)}
 * method (which is part of the {@link java.util.List List} interface).
 *
 ...
 *
 * <p>This method is identical in functionality to the
 * {@link #remove(java.lang.Object)} method (which is part of the
...
public synchronized boolean removeElement(@androidx.annotation.Nullable java.lang.Object obj) { throw new RuntimeException("Stub!"); }
 ...
 * @throws java.lang.ArrayStoreException if the runtime type of a is not a supertype
...
@androidx.annotation.NonNull
public synchronized <T> T[] toArray(@androidx.annotation.NonNull T[] a) { throw new RuntimeException("Stub!"); }
...
public synchronized boolean containsAll(@androidx.annotation.NonNull java.util.Collection<?> c) { throw new RuntimeException("Stub!"); }
...
public synchronized boolean addAll(@androidx.annotation.NonNull java.util.Collection<? extends E> c) { throw new RuntimeException("Stub!"); }
 ...
 * @throws java.lang.NullPointerException if this vector contains one or more null
...
public synchronized boolean removeAll(@androidx.annotation.NonNull java.util.Collection<?> c) { throw new RuntimeException("Stub!"); }
...
public synchronized boolean retainAll(@androidx.annotation.NonNull java.util.Collection<?> c) { throw new RuntimeException("Stub!"); }
...
public synchronized boolean addAll(int index, @androidx.annotation.NonNull java.util.Collection<? extends E> c) { throw new RuntimeException("Stub!"); }
...
public synchronized boolean equals(@androidx.annotation.Nullable java.lang.Object o) { throw new RuntimeException("Stub!"); }
...
public synchronized void forEach(@androidx.annotation.NonNull java.util.function.Consumer<? super E> action) { throw new RuntimeException("Stub!"); }

/** @apiSince 24 */

public synchronized boolean removeIf(@androidx.annotation.NonNull java.util.function.Predicate<? super E> filter) { throw new RuntimeException("Stub!"); }

/** @apiSince 24 */

public synchronized void replaceAll(@androidx.annotation.NonNull java.util.function.UnaryOperator<E> operator) { throw new RuntimeException("Stub!"); }

/** @apiSince 24 */

public synchronized void sort(@androidx.annotation.Nullable java.util.Comparator<? super E> c) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.NonNull protected java.lang.Object[] elementData;
}
