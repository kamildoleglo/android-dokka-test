 ...
 * or custom (via a supplied {@link java.util.concurrent.Executor Executor}).  The execution
 ...
 * {@link java.util.concurrent.CompletionException CompletionException} holding the exception as its cause.  If
 ...
 * value for any other parameter will result in a {@link java.lang.NullPointerException NullPointerException} being thrown.
 *
 ...
 *
 * <p>See the {@link java.util.concurrent.CompletionStage CompletionStage} documentation for rules
 ...
 *
 * See the {@link java.util.concurrent.CompletionStage CompletionStage} documentation for rules
 * covering exceptional completion.
 *
 * @param fn the function to use to compute the value of the
 * returned CompletionStage
 ...
 *
 * <p>Unlike method {@link #handleAsync(java.util.function.BiFunction) handleAsync},
 * this method is not designed to translate completion outcomes,
 * so the supplied action should not throw an exception. However,
 * if it does, the following rules apply: If this stage completed
 * normally but the supplied action throws an exception, then the
 ...
 * when the action returns.
 *
 * <p>Unlike method {@link #handleAsync(java.util.function.BiFunction,java.util.concurrent.Executor) handleAsync},
 * this method is not designed to translate completion outcomes,
 * so the supplied action should not throw an exception. However,
 * if it does, the following rules apply: If this stage completed
 * normally but the supplied action throws an exception, then the
...
/**
 * Returns a {@link java.util.concurrent.CompletableFuture CompletableFuture} maintaining the same
 ...
 * @throws java.lang.UnsupportedOperationException if this implementation
