...
/**
 * A {@link java.util.concurrent.ForkJoinTask ForkJoinTask} with a completion action performed when
 ...
 * {@link #onExceptionalCompletion(java.lang.Throwable,java.util.concurrent.CountedCompleter)} to
 ...
 * status (as reported in methods such as {@link java.util.concurrent.ForkJoinTask#isDone ForkJoinTask#isDone})
 * is arbitrary; this status changes only upon explicit invocations of
 * {@link #complete}, {@link java.util.concurrent.ForkJoinTask#cancel ForkJoinTask#cancel},
 * {@link java.util.concurrent.ForkJoinTask#completeExceptionally(java.lang.Throwable) ForkJoinTask#completeExceptionally(Throwable)} or upon
 ...
 * be arranged in trees similar to those often used with {@link java.util.concurrent.RecursiveAction RecursiveAction}s, although the constructions involved in setting
 ...
 * (here, implicitly using the {@link java.util.concurrent.ForkJoinPool#commonPool() ForkJoinPool#commonPool()}).
 *
 * <pre> {@code
 ...
 * #completeExceptionally(java.lang.Throwable)} is invoked or method {@link
 * #compute} throws an exception, and this task has not already
 * otherwise completed normally. On entry to this method, this task
 * {@link java.util.concurrent.ForkJoinTask#isCompletedAbnormally ForkJoinTask#isCompletedAbnormally}.  The return value
