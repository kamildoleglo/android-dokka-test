...
/**
 * A handler for tasks that cannot be executed by a {@link java.util.concurrent.ThreadPoolExecutor ThreadPoolExecutor}.
 *
 * @since 1.5
 * @author Doug Lea
 * @apiSince 1
 ...
 * an unchecked {@link java.util.concurrent.RejectedExecutionException RejectedExecutionException}, which will be
