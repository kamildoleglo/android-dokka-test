 ...
 * @throws java.lang.InterruptedException if the current thread is interrupted
 * @throws java.lang.IllegalArgumentException if {@code permits} is negative
 * @apiSince 1
 */
 ...
 * honor the fairness setting, then use {@link #tryAcquire(int,long,java.util.concurrent.TimeUnit) tryAcquire(permits, 0, TimeUnit.SECONDS) }
 * which is almost equivalent (it also detects interruption).
 *
 * @param permits the number of permits to acquire
 ...
 * @throws java.lang.IllegalArgumentException if {@code reduction} is negative
 * @apiSince 1
 */
