...
/**
 * An implementation of {@link java.util.concurrent.locks.ReadWriteLock ReadWriteLock} supporting similar
 * semantics to {@link java.util.concurrent.locks.ReentrantLock ReentrantLock}.
 ...
 * {@link java.util.concurrent.locks.ReentrantReadWriteLock.ReadLock#tryLock() ReadLock#tryLock()} and {@link java.util.concurrent.locks.ReentrantReadWriteLock.WriteLock#tryLock() WriteLock#tryLock()} methods
 ...
 * write locks in the style of a {@link java.util.concurrent.locks.ReentrantLock ReentrantLock}. Non-reentrant
 ...
 * acquisition.
 *
 * <li><b>{@link java.util.concurrent.locks.Condition Condition} support</b>
 * <p>The write lock provides a {@link java.util.concurrent.locks.Condition Condition} implementation that
 * behaves in the same way, with respect to the write lock, as the
 * {@link java.util.concurrent.locks.Condition Condition} implementation provided by
 * {@link java.util.concurrent.locks.ReentrantLock#newCondition ReentrantLock#newCondition} does for {@link java.util.concurrent.locks.ReentrantLock ReentrantLock}.
 * This {@link java.util.concurrent.locks.Condition Condition} can, of course, only be used with the write lock.
 *
 * <p>The read lock does not support a {@link java.util.concurrent.locks.Condition Condition} and
...
/**
 * The lock returned by method {@link java.util.concurrent.locks.ReentrantReadWriteLock#readLock ReentrantReadWriteLock#readLock}.
 * @apiSince 1
 */
 ...
 * @throws java.lang.NullPointerException if the lock is null
 * @apiSince 1
 */
 ...
 * </ul>
 *
 * then {@link java.lang.InterruptedException InterruptedException} is thrown and the current
 ...
 * thread does not hold this lock then {@link java.lang.IllegalMonitorStateException IllegalMonitorStateException} is thrown.
 *
 * @throws java.lang.IllegalMonitorStateException if the current thread
...
/**
 * The lock returned by method {@link java.util.concurrent.locks.ReentrantReadWriteLock#writeLock ReentrantReadWriteLock#writeLock}.
 * @apiSince 1
 */
 ...
 * not the holder of this lock then {@link java.lang.IllegalMonitorStateException IllegalMonitorStateException} is thrown.
 *
 ...
 * <ul>
 *
 * <li>If this write lock is not held when any {@link java.util.concurrent.locks.Condition Condition} method is called then an {@link java.lang.IllegalMonitorStateException IllegalMonitorStateException} is thrown.  (Read locks are
 ...
 * to {@link java.util.concurrent.locks.ReentrantReadWriteLock#getWriteHoldCount ReentrantReadWriteLock#getWriteHoldCount}.
 *
