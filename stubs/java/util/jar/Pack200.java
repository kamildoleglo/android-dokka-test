...
private Pack200() { throw new RuntimeException("Stub!"); }
 ...
 * constructor or method in this class will cause a {@link java.lang.NullPointerException NullPointerException}
 * to be thrown.
 * <p>
 * @since 1.5
 * @apiSince 1
 ...
 *
 * <p>
 * The returned map implements all optional {@link java.util.SortedMap SortedMap} operations
 ...
 * @exception java.io.IOException if an error is encountered.
 * @apiSince 1
 */
...
@Deprecated
public default void addPropertyChangeListener(java.beans.PropertyChangeListener listener) { throw new RuntimeException("Stub!"); }
...
@Deprecated
public default void removePropertyChangeListener(java.beans.PropertyChangeListener listener) { throw new RuntimeException("Stub!"); }
...
public void unpack(java.io.File in, java.util.jar.JarOutputStream out) throws java.io.IOException;
