 ...
 * @exception  java.lang.NullPointerException if pattern property is an empty String.
 * @apiSince 1
 */

public FileHandler() throws java.io.IOException, java.lang.SecurityException { throw new RuntimeException("Stub!"); }
 ...
 * @exception  java.lang.SecurityException  if a security manager exists and if
 *             the caller does not have <tt>LoggingPermission("control")</tt>.
 * @exception  java.lang.IllegalArgumentException if pattern is an empty string
 * @apiSince 1
 */

public FileHandler(java.lang.String pattern) throws java.io.IOException, java.lang.SecurityException { throw new RuntimeException("Stub!"); }
...
public FileHandler(java.lang.String pattern, boolean append) throws java.io.IOException, java.lang.SecurityException { throw new RuntimeException("Stub!"); }
 ...
 * @exception  java.lang.SecurityException  if a security manager exists and if
 *             the caller does not have <tt>LoggingPermission("control")</tt>.
 * @exception  java.lang.IllegalArgumentException if {@code limit < 0}, or {@code count < 1}.
 * @exception  java.lang.IllegalArgumentException if pattern is an empty string
 * @apiSince 1
 */

public FileHandler(java.lang.String pattern, int limit, int count) throws java.io.IOException, java.lang.SecurityException { throw new RuntimeException("Stub!"); }
...
public FileHandler(java.lang.String pattern, int limit, int count, boolean append) throws java.io.IOException, java.lang.SecurityException { throw new RuntimeException("Stub!"); }
