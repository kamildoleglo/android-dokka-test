 ...
 * be identified by the fact that they are declared to throw {@link java.util.prefs.BackingStoreException BackingStoreException}.
 *
 ...
 * }</pre>
 *
 * Every <tt>Preferences</tt> implementation must have an associated {@link java.util.prefs.PreferencesFactory PreferencesFactory} implementation.  Every Java(TM) SE implementation must provide
 ...
 *         <tt>c</tt> is a member.
 * @throws java.lang.NullPointerException if <tt>c</tt> is <tt>null</tt>.
 ...
 * {@link java.lang.Integer#toString(int) Integer#toString(int)}.  This method is intended for use in
 ...
 * an integer as by {@link java.lang.Integer#parseInt(java.lang.String) Integer#parseInt(String)}.  Returns the
 * specified default if there is no value associated with the key,
 * the backing store is inaccessible, or if
 * <tt>Integer.parseInt(String)</tt> would throw a {@link java.lang.NumberFormatException NumberFormatException} if the associated value were passed.  This
 ...
 * {@link java.lang.Long#toString(long) Long#toString(long)}.  This method is intended for use in
 ...
 * specified key in this preference node.  The string is converted to
 * a long as by {@link java.lang.Long#parseLong(java.lang.String) Long#parseLong(String)}.  Returns the
 * specified default if there is no value associated with the key,
 * the backing store is inaccessible, or if
 * <tt>Long.parseLong(String)</tt> would throw a {@link java.lang.NumberFormatException NumberFormatException} if the associated value were passed.  This
 ...
 * {@link java.lang.Float#toString(float) Float#toString(float)}.  This method is intended for use in
 ...
 * integer as by {@link java.lang.Float#parseFloat(java.lang.String) Float#parseFloat(String)}.  Returns the specified
 ...
 * {@link java.lang.NumberFormatException NumberFormatException} if the associated value were passed.
 ...
 * {@link java.lang.Double#toString(double) Double#toString(double)}.  This method is intended for use in
 ...
 * specified key in this preference node.  The string is converted to an
 * integer as by {@link java.lang.Double#parseDouble(java.lang.String) Double#parseDouble(String)}.  Returns the specified
 * default if there is no value associated with the key, the backing store
 ...
 * @throws java.lang.NullPointerException if path name is <tt>null</tt>.
 * @throws java.lang.IllegalStateException if this node (or an ancestor) has been
 *         removed with the {@link #removeNode()} method.
 * @see #flush()
 * @apiSince 1
 ...
 * {@link #node(java.lang.String) nodeExists("")} on the corresponding
 * <tt>Preferences</tt> instance will fail with an
 * <tt>IllegalStateException</tt>.  (The methods defined on {@link java.lang.Object Object}
 ...
 * @throws java.lang.NullPointerException if <tt>pcl</tt> is null.
 * @throws java.lang.IllegalStateException if this node (or an ancestor) has been
 *         removed with the {@link #removeNode()} method.
 ...
 * @throws java.lang.IllegalArgumentException if <tt>pcl</tt> was not a registered
 ...
 * @throws java.lang.NullPointerException if <tt>ncl</tt> is null.
 * @throws java.lang.IllegalStateException if this node (or an ancestor) has been
 *         removed with the {@link #removeNode()} method.
 ...
 * @throws java.lang.IllegalArgumentException if <tt>ncl</tt> was not a registered
...
public abstract void exportNode(java.io.OutputStream os) throws java.util.prefs.BackingStoreException, java.io.IOException;
...
public abstract void exportSubtree(java.io.OutputStream os) throws java.util.prefs.BackingStoreException, java.io.IOException;
 ...
 * {@link #exportNode(java.io.OutputStream)} and
 * {@link #exportSubtree(java.io.OutputStream)}.
 *
 * <p>This method is an exception to the general rule that the results of
 * concurrently executing multiple methods in this class yields
 ...
 * notably {@link #node(java.lang.String)} and {@link #put(java.lang.String,java.lang.String)}.
 *
 ...
 *         results in an <tt>IOException</tt>.
 * @throws java.util.prefs.InvalidPreferencesFormatException Data on input stream does not
...
public static final int MAX_KEY_LENGTH = 80; // 0x50
...
public static final int MAX_NAME_LENGTH = 80; // 0x50
...
public static final int MAX_VALUE_LENGTH = 8192; // 0x2000
}
