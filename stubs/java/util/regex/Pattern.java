 ...
 * a {@link java.util.regex.Matcher Matcher} object that can match arbitrary {@linkplain
 ...
 * concurrent threads.  Instances of the {@link java.util.regex.Matcher Matcher} class are not safe for
 * such use.
 *
 *
...
private Pattern() { throw new RuntimeException("Stub!"); }
...
public static java.util.regex.Pattern compile(@androidx.annotation.NonNull java.lang.String regex) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.NonNull
public static java.util.regex.Pattern compile(@androidx.annotation.NonNull java.lang.String regex, int flags) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.NonNull
public java.util.regex.Matcher matcher(@androidx.annotation.NonNull java.lang.CharSequence input) { throw new RuntimeException("Stub!"); }
...
public static boolean matches(@androidx.annotation.NonNull java.lang.String regex, @androidx.annotation.NonNull java.lang.CharSequence input) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.NonNull
public java.lang.String[] split(@androidx.annotation.NonNull java.lang.CharSequence input, int limit) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.NonNull
public java.lang.String[] split(@androidx.annotation.NonNull java.lang.CharSequence input) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.NonNull
public static java.lang.String quote(@androidx.annotation.NonNull java.lang.String s) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.NonNull
public java.util.stream.Stream<java.lang.String> splitAsStream(@androidx.annotation.NonNull java.lang.CharSequence input) { throw new RuntimeException("Stub!"); }
