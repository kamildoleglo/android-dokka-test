 ...
 * {@link java.util.stream.Stream Stream} and {@link java.util.stream.DoubleStream DoubleStream}, computing the sum of the weights of the
 * red widgets:
 *
 * <pre>{@code
 ...
 * stream source (such as {@link #generate(java.util.function.DoubleSupplier)}) or removing the
 ...
 * }</pre>
 *
 * <p>Like {@link #reduce(double,java.util.function.DoubleBinaryOperator)}, {@code collect}
...
/**
 * Returns an {@link java.util.OptionalDouble OptionalDouble} describing the first element of this
...
/**
 * Returns an {@link java.util.OptionalDouble OptionalDouble} describing some element of the stream,
