 ...
 * {@link java.util.stream.Stream Stream} and {@link java.util.stream.LongStream LongStream}, computing the sum of the weights of the
 * red widgets:
 *
 * <pre>{@code
 ...
 * stream source (such as {@link #generate(java.util.function.LongSupplier)}) or removing the
 ...
 * }</pre>
 *
 * <p>Like {@link #reduce(long,java.util.function.LongBinaryOperator)}, {@code collect} operations
...
/**
 * Returns an {@link java.util.OptionalLong OptionalLong} describing the first element of this
...
/**
 * Returns an {@link java.util.OptionalLong OptionalLong} describing some element of the stream, or
