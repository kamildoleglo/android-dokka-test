 ...
 * {@link java.util.stream.Stream Stream} and {@link java.util.stream.IntStream IntStream}:
 *
 * <pre>{@code
 ...
 * there are primitive specializations for {@link java.util.stream.IntStream IntStream}, {@link java.util.stream.LongStream LongStream},
 * and {@link java.util.stream.DoubleStream DoubleStream}, all of which are referred to as "streams" and
 ...
 * stream into another stream, such as {@link java.util.stream.Stream#filter(java.util.function.Predicate) Stream#filter(Predicate)}), and a
 * <em>terminal operation</em> (which produces a result or side-effect, such
 * as {@link java.util.stream.Stream#count() Stream#count()} or {@link java.util.stream.Stream#forEach(java.util.function.Consumer) Stream#forEach(Consumer)}).
 ...
 * designed for concurrent modification (such as a {@link java.util.concurrent.ConcurrentHashMap ConcurrentHashMap}),
 ...
 * same stream.  A stream implementation may throw {@link java.lang.IllegalStateException IllegalStateException}
 * if it detects that the stream is being reused. However, since some stream
 * operations may return their receiver rather than a new stream object, it may
 * not be possible to detect reuse in all cases.
 *
 * <p>Streams have a {@link #close()} method and implement {@link java.lang.AutoCloseable AutoCloseable},
 * but nearly all stream instances do not actually need to be closed after use.
 * Generally, only streams whose source is an IO channel (such as those returned
 * by {@link java.nio.file.Files#lines(java.nio.file.Path,java.nio.charset.Charset) Files#lines(Path, Charset)}) will require closing.  Most streams
 ...
 * {@link java.lang.Object#equals(java.lang.Object) Object#equals(Object)}) of this stream.
 *
 ...
 * Using an unordered stream source (such as {@link #generate(java.util.function.Supplier)})
 ...
 * stream source (such as {@link #generate(java.util.function.Supplier)}) or removing the
 ...
 * @throws java.lang.ArrayStoreException if the runtime type of the array returned
 ...
 *                    <a href="package-summary.html#Statelessness">stateless</a>
 *                    function for combining two values
 * @return an {@link java.util.Optional Optional} describing the result of the reduction
 * @throws java.lang.NullPointerException if the result of the reduction is null
 ...
 * }</pre>
 *
 * <p>Like {@link #reduce(java.lang.Object,java.util.function.BinaryOperator)}, {@code collect} operations
 ...
 * {@link #collect(java.util.function.Supplier,java.util.function.BiConsumer,java.util.function.BiConsumer)}, allowing for reuse of
...
/**
 * Returns an {@link java.util.Optional Optional} describing the first element of this stream,
...
/**
 * Returns an {@link java.util.Optional Optional} describing some element of the stream, or an
