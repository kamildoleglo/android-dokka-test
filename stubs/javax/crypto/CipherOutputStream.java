...
public CipherOutputStream(java.io.OutputStream os, javax.crypto.Cipher c) { super(null); throw new RuntimeException("Stub!"); }
...
protected CipherOutputStream(java.io.OutputStream os) { super(null); throw new RuntimeException("Stub!"); }
 ...
 *
 * @param      b   the data.
 * @exception  java.lang.NullPointerException if <code>b</code> is null.
 * @exception  java.io.IOException  if an I/O error occurs.
