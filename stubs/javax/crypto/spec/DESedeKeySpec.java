 ...
 * @exception java.security.InvalidKeyException if the given key material is shorter
 * than 24 bytes.
 * @apiSince 1
 */

public DESedeKeySpec(byte[] key) throws java.security.InvalidKeyException { throw new RuntimeException("Stub!"); }
 ...
 *
 * @exception java.lang.NullPointerException if <code>key</code> is null.
 * @exception java.security.InvalidKeyException if the given key material, starting at
 * <code>offset</code> inclusive, is shorter than 24 bytes
 * @apiSince 1
 */

public DESedeKeySpec(byte[] key, int offset) throws java.security.InvalidKeyException { throw new RuntimeException("Stub!"); }
...
public static final int DES_EDE_KEY_LEN = 24; // 0x18
}
