 ...
 * @throws java.lang.NullPointerException if <code>iv</code> is <code>null</code>
 * @apiSince 1
 */
 ...
 * @throws java.lang.IllegalArgumentException if <code>iv</code> is <code>null</code>
 * or {@code (iv.length - offset < len)}
 * @throws java.lang.ArrayIndexOutOfBoundsException is thrown if <code>offset</code>
 * or <code>len</code> index bytes outside the <code>iv</code>.
 * @apiSince 1
 */

public IvParameterSpec(byte[] iv, int offset, int len) { throw new RuntimeException("Stub!"); }
