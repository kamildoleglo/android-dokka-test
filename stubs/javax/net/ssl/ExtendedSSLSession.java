...
public ExtendedSSLSession() { throw new RuntimeException("Stub!"); }
...
/**
 * Obtains a {@link java.util.List List} containing all {@link javax.net.ssl.SNIServerName SNIServerName}s
 * of the requested Server Name Indication (SNI) extension.
 * <P>
 * In server mode, unless the return {@link java.util.List List} is empty,
 ...
 * <P>
 * In client mode, unless the return {@link java.util.List List} is empty,
 * the client should use the requested server names to guide its
 * endpoint identification of the peer's identity, and/or
 * other aspects of security policy.
 *
 * @return a non-null immutable list of {@link javax.net.ssl.SNIServerName SNIServerName}s of the
...
public java.util.List<javax.net.ssl.SNIServerName> getRequestedServerNames() { throw new RuntimeException("Stub!"); }
}
