 ...
 *          specified algorithm.
 * @exception java.lang.NullPointerException if <code>algorithm</code> is null.
 *
 ...
 * @return the new <code>KeyManagerFactory</code> object.
 *
 * @throws java.security.NoSuchAlgorithmException if a KeyManagerFactorySpi
 ...
 * @throws java.lang.NullPointerException if <code>algorithm</code> is null.
 *
 * @see java.security.Provider
 * @apiSince 1
 */
 ...
 *          specification
 * @throws java.security.InvalidAlgorithmParameterException if an error is encountered
 * @apiSince 1
 */
