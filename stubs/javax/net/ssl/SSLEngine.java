 ...
 * initial handshake.
 * <P>
 * Data moves through the engine by calling {@link #wrap(java.nio.ByteBuffer,java.nio.ByteBuffer) wrap()} or {@link #unwrap(java.nio.ByteBuffer,java.nio.ByteBuffer)
 ...
 * were to return a {@link javax.net.ssl.SSLEngineResult.Status#BUFFER_UNDERFLOW SSLEngineResult.Status#BUFFER_UNDERFLOW}, the
 * application should call {@link javax.net.ssl.SSLSession#getPacketBufferSize() SSLSession#getPacketBufferSize()} to ensure
 ...
 *      {@link #setEnabledCipherSuites(java.lang.String[])} method, and
 ...
 * <p>{@code SSLEngine} instances obtained from the default {@link javax.net.ssl.SSLContext SSLContext} are configured as
 * follows:
 *
 * <style type="text/css">
 *   tr.deprecated {
 ...
 *          is null.
 * @throws  java.lang.IllegalStateException if the client/server mode
 ...
 * as the invocation:
 * <blockquote><pre>
 * {@link #unwrap(java.nio.ByteBuffer,java.nio.ByteBuffer[],int,int)
 ...
 * <P>
 * {@link #wrap(java.nio.ByteBuffer,java.nio.ByteBuffer) wrap()} should be
...
/**
 * Returns whether {@link #unwrap(java.nio.ByteBuffer,java.nio.ByteBuffer)} will
 ...
 * been closed, this method does not do anything.
 * <P>
 * {@link #wrap(java.nio.ByteBuffer,java.nio.ByteBuffer)} should be
 * called to flush any remaining handshake data.
 *
 * @see     #isOutboundDone()
 * @apiSince 1
...
/**
 * Returns whether {@link #wrap(java.nio.ByteBuffer,java.nio.ByteBuffer)} will
 ...
 * @throws  java.lang.IllegalArgumentException when one or more of the ciphers
 ...
 * @throws  java.lang.IllegalArgumentException when one or more of
 ...
 * and server.
 * <P>
 * Unlike {@link javax.net.ssl.SSLSocket#getSession() SSLSocket#getSession()}
 ...
 *          in "client" mode
 * @throws  java.lang.IllegalArgumentException if a mode change is attempted
 ...
 * @throws java.lang.IllegalArgumentException if the setEnabledCipherSuites() or
...
public java.lang.String getApplicationProtocol() { throw new RuntimeException("Stub!"); }
...
public java.lang.String getHandshakeApplicationProtocol() { throw new RuntimeException("Stub!"); }
 ...
 * See {@link javax.net.ssl.SSLParameters SSLParameters}.
 *
 * @implSpec
 * The implementation in this class throws
 * {@code UnsupportedOperationException} and performs no other action.
...
public void setHandshakeApplicationProtocolSelector(java.util.function.BiFunction<javax.net.ssl.SSLEngine,java.util.List<java.lang.String>,java.lang.String> selector) { throw new RuntimeException("Stub!"); }
...
public java.util.function.BiFunction<javax.net.ssl.SSLEngine,java.util.List<java.lang.String>,java.lang.String> getHandshakeApplicationProtocolSelector() { throw new RuntimeException("Stub!"); }
}
