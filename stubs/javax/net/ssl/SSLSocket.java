 ...
 * <p>{@code SSLSocket} instances obtained from default {@link javax.net.ssl.SSLSocketFactory SSLSocketFactory},
 * {@link javax.net.ssl.SSLServerSocketFactory SSLServerSocketFactory}, and {@link javax.net.ssl.SSLContext SSLContext} are configured as follows:
 *
 * <style type="text/css">
 *   tr.deprecated {
 ...
 * {@link #setEnabledCipherSuites(java.lang.String[]) setEnabledCipherSuites}) have used
 ...
 *         <code>checkConnect</code> method doesn't allow the operation.
 * @throws java.net.UnknownHostException if the host is not known
 * @throws java.lang.IllegalArgumentException if the port parameter or clientPort
 ...
 *
 * @param listener the HandShake Completed event listener
 * @throws java.lang.IllegalArgumentException if the listener is not registered,
...
public void setHandshakeApplicationProtocolSelector(java.util.function.BiFunction<javax.net.ssl.SSLSocket,java.util.List<java.lang.String>,java.lang.String> selector) { throw new RuntimeException("Stub!"); }
...
public java.util.function.BiFunction<javax.net.ssl.SSLSocket,java.util.List<java.lang.String>,java.lang.String> getHandshakeApplicationProtocolSelector() { throw new RuntimeException("Stub!"); }
