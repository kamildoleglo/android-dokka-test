 ...
 * versions of Android.
 *
 * @exception javax.security.auth.DestroyFailedException if the destroy operation fails. <p>
 *
 * @exception java.lang.SecurityException if the caller does not have permission
 *          to destroy this {@code Object}.
 * @apiSince 1
 */

public default void destroy() throws javax.security.auth.DestroyFailedException { throw new RuntimeException("Stub!"); }
