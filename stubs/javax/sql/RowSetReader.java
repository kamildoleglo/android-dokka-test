 ...
 * @exception java.sql.SQLException if a database access error occurs or this method
 *            invokes the <code>RowSet.execute</code> method
 * @apiSince 1
 */

public void readData(javax.sql.RowSetInternal caller) throws java.sql.SQLException;
}
