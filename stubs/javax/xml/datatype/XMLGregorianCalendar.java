 ...
 *            or {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}.<br/>
 ...
 *       <td> month </td>
 *       <td> {@link #getMonth()} </td>
 *       <td> 1 to 12 or {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED} </td>
 *     </tr>
 *     <a name="datetimefield-day"/>
 *     <tr>
 *       <td> day </td>
 *       <td> {@link #getDay()} </td>
 *       <td> Independent of month, max range is 1 to 31 or {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}.<br/>
 ...
 *       <td>{@link #getHour()}</td>
 *       <td>
 *         0 to 24 or {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}.
 ...
 *       <td> 0 to 59 or {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED} </td>
 *     </tr>
 ...
 *       </td>
 *       <td>
 *         {@link #getSecond()} from 0 to 60 or {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}.<br/>
 ...
 *       <td> Number of minutes or {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}.
 ...
 *     {@link #toString()}, {@link javax.xml.datatype.DatatypeFactory#newXMLGregorianCalendar(java.lang.String) DatatypeFactory#newXMLGregorianCalendar(String lexicalRepresentation)}</li>
 *   <li>conversion between this class and {@link java.util.GregorianCalendar GregorianCalendar},
 *     {@link #toGregorianCalendar(java.util.TimeZone timezone,java.util.Locale aLocale,javax.xml.datatype.XMLGregorianCalendar)},
 *     {@link javax.xml.datatype.DatatypeFactory DatatypeFactory}</li>
 *   <li>partial order relation comparator method, {@link #compare(javax.xml.datatype.XMLGregorianCalendar)}</li>
 *   <li>{@link #equals(java.lang.Object)} defined relative to {@link #compare(javax.xml.datatype.XMLGregorianCalendar)}.</li>
 *   <li>addition operation with {@link javax.xml.datatype.Duration Duration}
 ...
 *
 * <p>Set all int fields to {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED} and reference fields
 * to null.</p>
 * @apiSince 8
 */
 ...
 * {@link javax.xml.datatype.DatatypeFactory#newXMLGregorianCalendar() DatatypeFactory#newXMLGregorianCalendar()},
 * {@link javax.xml.datatype.DatatypeFactory#newXMLGregorianCalendar(java.lang.String) DatatypeFactory#newXMLGregorianCalendar(String lexicalRepresentation)},
 * {@link javax.xml.datatype.DatatypeFactory#newXMLGregorianCalendar(java.math.BigInteger,int month,int day,int hour,int minute,int second,java.math.BigDecimal,int timezone) DatatypeFactory#newXMLGregorianCalendar(
 *   BigInteger year,
 *   int month,
 *   int day,
 *   int hour,
 ...
 *   int timezone)},
 * {@link javax.xml.datatype.DatatypeFactory#newXMLGregorianCalendar(int year,int month,int day,int hour,int minute,int second,int millisecond,int timezone) DatatypeFactory#newXMLGregorianCalendar(
 *   int year,
 *   int month,
 *   int day,
 *   int hour,
 ...
 *   int millisecond,
 *   int timezone)},
 * {@link javax.xml.datatype.DatatypeFactory#newXMLGregorianCalendar(java.util.GregorianCalendar) DatatypeFactory#newXMLGregorianCalendar(GregorianCalendar cal)},
 * {@link javax.xml.datatype.DatatypeFactory#newXMLGregorianCalendarDate(int year,int month,int day,int timezone) DatatypeFactory#newXMLGregorianCalendarDate(
 *   int year,
 *   int month,
 *   int day,
 *   int timezone)},
 * {@link javax.xml.datatype.DatatypeFactory#newXMLGregorianCalendarTime(int hours,int minutes,int seconds,int timezone) DatatypeFactory#newXMLGregorianCalendarTime(
 *   int hours,
 *   int minutes,
 *   int seconds,
 *   int timezone)},
 * {@link javax.xml.datatype.DatatypeFactory#newXMLGregorianCalendarTime(int hours,int minutes,int seconds,java.math.BigDecimal,int timezone) DatatypeFactory#newXMLGregorianCalendarTime(
 *   int hours,
 *   int minutes,
 *   int seconds,
 *   BigDecimal fractionalSecond,
 *   int timezone)} or
 * {@link javax.xml.datatype.DatatypeFactory#newXMLGregorianCalendarTime(int hours,int minutes,int seconds,int milliseconds,int timezone) DatatypeFactory#newXMLGregorianCalendarTime(
 *   int hours,
 *   int minutes,
 *   int seconds,
 *   int milliseconds,
 ...
 *
 * @throws java.lang.IllegalArgumentException if <code>year</code> parameter is
 ...
 *   If year is {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}, then eon is set to <code>null</code>.
 * @apiSince 8
 */
 ...
 * <p>Set month.</p>
 *
 * <p>Unset this field by invoking the setter with a parameter value of {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}.</p>
 *
 * @param month value constraints summarized in <a href="#datetimefield-month">month field of date/time field mapping table</a>.
 *
 * @throws java.lang.IllegalArgumentException if <code>month</code> parameter is
 * outside value constraints for the field as specified in
 * <a href="#datetimefieldmapping">date/time field mapping table</a>.
 * @apiSince 8
 */
 ...
 *
 * @throws java.lang.IllegalArgumentException if <code>day</code> parameter is
 * outside value constraints for the field as specified in
 * <a href="#datetimefieldmapping">date/time field mapping table</a>.
 * @apiSince 8
 */
 ...
 *
 * @throws java.lang.IllegalArgumentException if <code>offset</code> parameter is
 * outside value constraints for the field as specified in
 * <a href="#datetimefieldmapping">date/time field mapping table</a>.
 * @apiSince 8
 */
 ...
 *
 * @throws java.lang.IllegalArgumentException if any parameter is
 * outside value constraints for the field as specified in
 * <a href="#datetimefieldmapping">date/time field mapping table</a>.
 * @apiSince 8
 */
 ...
 *
 * @throws java.lang.IllegalArgumentException if <code>hour</code> parameter is outside value constraints for the field as specified in
 *   <a href="#datetimefieldmapping">date/time field mapping table</a>.
 * @apiSince 8
 */
 ...
 *
 * @throws java.lang.IllegalArgumentException if <code>minute</code> parameter is outside value constraints for the field as specified in
 *   <a href="#datetimefieldmapping">date/time field mapping table</a>.
 * @apiSince 8
 */
 ...
 *
 * @throws java.lang.IllegalArgumentException if <code>second</code> parameter is outside value constraints for the field as specified in
 *   <a href="#datetimefieldmapping">date/time field mapping table</a>.
 * @apiSince 8
 */
 ...
 *
 * @throws java.lang.IllegalArgumentException if <code>millisecond</code> parameter is outside value constraints for the field as specified
 ...
 *
 * @throws java.lang.IllegalArgumentException if <code>fractional</code> parameter is outside value constraints for the field as specified
 *   in <a href="#datetimefieldmapping">date/time field mapping table</a>.
 * @apiSince 8
 */
 ...
 * @param second value constraints are summarized in
 * <a href="#datetimefield-second">second field of date/time field mapping table</a>.
 * @param millisecond value of {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED} indicates this
 ...
 * <code>year</code> or {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}.</p>
 *
 * <p>Value constraints for this value are summarized in
 * <a href="#datetimefield-year">year field of date/time field mapping table</a>.</p>
 *
...
/**
 * <p>Return number of month or {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}.</p>
 *
 * <p>Value constraints for this value are summarized in
...
/**
 * Return day in month or {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}.</p>
 *
 * <p>Value constraints for this value are summarized in
 ...
 * {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED} if this optional field is not defined.
 *
 * <p>Value constraints for this value are summarized in
...
/**
 * Return hours or {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}.
 * Returns {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED} if this field is not defined.
 *
 * <p>Value constraints for this value are summarized in
...
/**
 * Return minutes or {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}.</p>
 * Returns {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED} if this field is not defined.
 *
 * <p>Value constraints for this value are summarized in
...
/**
 * <p>Return seconds or {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}.</p>
 *
 * <p>Returns {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED} if this field is not defined.
 ...
 * does not return {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}.</p>
 *
 ...
 *   {@link javax.xml.datatype.DatatypeConstants#LESSER DatatypeConstants#LESSER},
 *   {@link javax.xml.datatype.DatatypeConstants#EQUAL DatatypeConstants#EQUAL},
 *   {@link javax.xml.datatype.DatatypeConstants#GREATER DatatypeConstants#GREATER} or
 *   {@link javax.xml.datatype.DatatypeConstants#INDETERMINATE DatatypeConstants#INDETERMINATE}.
 *
 * @throws java.lang.NullPointerException if <code>xmlGregorianCalendar</code> is null.
 * @apiSince 8
 */
 ...
 *   and  {@link #compare(javax.xml.datatype.XMLGregorianCalendar)} returns {@link javax.xml.datatype.DatatypeConstants#EQUAL DatatypeConstants#EQUAL}, otherwise <code>false</code>.
 * @apiSince 8
 */
 ...
 *     </tr>
 *     <tr>
 *       <td>{@link javax.xml.datatype.DatatypeConstants#DATETIME DatatypeConstants#DATETIME}</td>
 *       <td>X</td>
 *       <td>X</td>
 *       <td>X</td>
 *       <td>X</td>
 ...
 *     </tr>
 *     <tr>
 *       <td>{@link javax.xml.datatype.DatatypeConstants#DATE DatatypeConstants#DATE}</td>
 *       <td>X</td>
 *       <td>X</td>
 *       <td>X</td>
 *       <td></td>
 ...
 *     </tr>
 *     <tr>
 *       <td>{@link javax.xml.datatype.DatatypeConstants#TIME DatatypeConstants#TIME}</td>
 *       <td></td>
 *       <td></td>
 *       <td></td>
 *       <td>X</td>
 ...
 *     </tr>
 *     <tr>
 *       <td>{@link javax.xml.datatype.DatatypeConstants#GYEARMONTH DatatypeConstants#GYEARMONTH}</td>
 *       <td>X</td>
 *       <td>X</td>
 *       <td></td>
 *       <td></td>
 ...
 *     </tr>
 *     <tr>
 *       <td>{@link javax.xml.datatype.DatatypeConstants#GMONTHDAY DatatypeConstants#GMONTHDAY}</td>
 *       <td></td>
 *       <td>X</td>
 *       <td>X</td>
 *       <td></td>
 ...
 *     </tr>
 *     <tr>
 *       <td>{@link javax.xml.datatype.DatatypeConstants#GYEAR DatatypeConstants#GYEAR}</td>
 *       <td>X</td>
 *       <td></td>
 *       <td></td>
 *       <td></td>
 ...
 *     </tr>
 *     <tr>
 *       <td>{@link javax.xml.datatype.DatatypeConstants#GMONTH DatatypeConstants#GMONTH}</td>
 *       <td></td>
 *       <td>X</td>
 *       <td></td>
 *       <td></td>
 ...
 *     </tr>
 *     <tr>
 *       <td>{@link javax.xml.datatype.DatatypeConstants#GDAY DatatypeConstants#GDAY}</td>
 *       <td></td>
 *       <td></td>
 *       <td>X</td>
 *       <td></td>
 ...
 *   {@link javax.xml.datatype.DatatypeConstants#DATETIME DatatypeConstants#DATETIME},
 *   {@link javax.xml.datatype.DatatypeConstants#TIME DatatypeConstants#TIME},
 *   {@link javax.xml.datatype.DatatypeConstants#DATE DatatypeConstants#DATE},
 *   {@link javax.xml.datatype.DatatypeConstants#GYEARMONTH DatatypeConstants#GYEARMONTH},
 *   {@link javax.xml.datatype.DatatypeConstants#GMONTHDAY DatatypeConstants#GMONTHDAY},
 *   {@link javax.xml.datatype.DatatypeConstants#GYEAR DatatypeConstants#GYEAR},
 *   {@link javax.xml.datatype.DatatypeConstants#GMONTH DatatypeConstants#GMONTH} or
 *   {@link javax.xml.datatype.DatatypeConstants#GDAY DatatypeConstants#GDAY}.
 * @apiSince 8
 */
 ...
 *
 * @throws java.lang.NullPointerException  when <code>duration</code> parameter is <code>null</code>.
 * @apiSince 8
 */
...
/**
 * <p>Convert this <code>XMLGregorianCalendar</code> to a {@link java.util.GregorianCalendar GregorianCalendar}.</p>
 *
 ...
 *       <td>{@link #getMonth()} - {@link javax.xml.datatype.DatatypeConstants#JANUARY DatatypeConstants#JANUARY} + {@link java.util.GregorianCalendar#JANUARY GregorianCalendar#JANUARY}</td>
 *     </tr>
 *     <tr>
 ...
 * to a {@link java.util.GregorianCalendar GregorianCalendar} instance.</p>
 *
 ...
 *   </li>
 *   <li>Initialize all GregorianCalendar fields by calling {@link java.util.GregorianCalendar#clear() GregorianCalendar#clear()}</li>
 *   <li>Obtain a pure Gregorian Calendar by invoking
 *   <code>GregorianCalendar.setGregorianChange(
 *   new Date(Long.MIN_VALUE))</code>.</li>
 *   <li>Its fields ERA, YEAR, MONTH, DAY_OF_MONTH, HOUR_OF_DAY,
 ...
 * {@link javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED DatatypeConstants#FIELD_UNDEFINED}.
 *
