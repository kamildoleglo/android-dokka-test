 ...
 * {@link javax.xml.parsers.SAXParserFactory#newSAXParser() SAXParserFactory#newSAXParser()}.
 ...
 *
 * <p>The reset <code>SAXParser</code> is not guaranteed to have the same {@link javax.xml.validation.Schema Schema}
 * <code>Object</code>, e.g. {@link java.lang.Object#equals(java.lang.Object) Object#equals(Object obj)}.  It is guaranteed to have a functionally equal
 * <code>Schema</code>.</p>
 *
 * @since 1.5
 * @apiSince 1
 ...
 * @throws org.xml.sax.SAXException If parse produces a SAX error.
 * @throws java.io.IOException If an IO error occurs interacting with the
...
public void parse(java.io.InputStream is, org.xml.sax.HandlerBase hb) throws java.io.IOException, org.xml.sax.SAXException { throw new RuntimeException("Stub!"); }
 ...
 *
 * @throws java.lang.IllegalArgumentException If the given <code>InputStream</code> is
 *   <code>null</code>.
 * @throws java.io.IOException If any IO error occurs interacting with the
 *   <code>InputStream</code>.
...
public void parse(java.io.InputStream is, org.xml.sax.HandlerBase hb, java.lang.String systemId) throws java.io.IOException, org.xml.sax.SAXException { throw new RuntimeException("Stub!"); }
...
public void parse(java.io.InputStream is, org.xml.sax.helpers.DefaultHandler dh) throws java.io.IOException, org.xml.sax.SAXException { throw new RuntimeException("Stub!"); }
...
public void parse(java.io.InputStream is, org.xml.sax.helpers.DefaultHandler dh, java.lang.String systemId) throws java.io.IOException, org.xml.sax.SAXException { throw new RuntimeException("Stub!"); }
...
public void parse(java.lang.String uri, org.xml.sax.HandlerBase hb) throws java.io.IOException, org.xml.sax.SAXException { throw new RuntimeException("Stub!"); }
...
public void parse(java.lang.String uri, org.xml.sax.helpers.DefaultHandler dh) throws java.io.IOException, org.xml.sax.SAXException { throw new RuntimeException("Stub!"); }
 ...
 * @param hb The SAX HandlerBase to use.
 *
 * @throws java.lang.IllegalArgumentException If the File object is null.
 * @throws java.io.IOException If any IO errors occur.
 * @throws org.xml.sax.SAXException If any SAX errors occur during processing.
 *
 * @see org.xml.sax.DocumentHandler
...
public void parse(java.io.File f, org.xml.sax.HandlerBase hb) throws java.io.IOException, org.xml.sax.SAXException { throw new RuntimeException("Stub!"); }
...
public void parse(java.io.File f, org.xml.sax.helpers.DefaultHandler dh) throws java.io.IOException, org.xml.sax.SAXException { throw new RuntimeException("Stub!"); }
 ...
 * @param hb The SAX HandlerBase to use.
 *
 * @throws java.lang.IllegalArgumentException If the <code>InputSource</code> object
 *   is <code>null</code>.
 * @throws java.io.IOException If any IO errors occur.
 * @throws org.xml.sax.SAXException If any SAX errors occur during processing.
 *
...
public void parse(org.xml.sax.InputSource is, org.xml.sax.HandlerBase hb) throws java.io.IOException, org.xml.sax.SAXException { throw new RuntimeException("Stub!"); }
...
public void parse(org.xml.sax.InputSource is, org.xml.sax.helpers.DefaultHandler dh) throws java.io.IOException, org.xml.sax.SAXException { throw new RuntimeException("Stub!"); }
 ...
 *
 * @throws org.xml.sax.SAXNotRecognizedException When the underlying XMLReader does
 *   not recognize the property name.
 * @throws org.xml.sax.SAXNotSupportedException When the underlying XMLReader
 ...
 * @return
 *      the return value of
 *      the {@link javax.xml.parsers.SAXParserFactory#isXIncludeAware() SAXParserFactory#isXIncludeAware()}
 ...
 * @since 1.5
 *
 * @see javax.xml.parsers.SAXParserFactory#setXIncludeAware(boolean)
 * @apiSince 1
 */
