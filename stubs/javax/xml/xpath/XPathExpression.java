 ...
 * @throws java.lang.NullPointerException If  <code>returnType</code> is <code>null</code>.
 * @apiSince 8
 */
 ...
 *
 * <p>This method calls {@link #evaluate(java.lang.Object,javax.xml.namespace.QName)} with a <code>returnType</code> of
 ...
 * {@link #evaluate(java.lang.Object,javax.xml.namespace.QName)} on the resulting document object.</p>
 *
 * <p>See <a href="#XPathExpression-evaluation">Evaluation of XPath Expressions</a> for context item evaluation,
 * variable, function and QName resolution and return type conversion.</p>
 *
 ...
 * @throws javax.xml.xpath.XPathExpressionException If the expression cannot be evaluated.
 * @throws java.lang.IllegalArgumentException If <code>returnType</code> is not one of the types defined in {@link javax.xml.xpath.XPathConstants XPathConstants}.
 * @throws java.lang.NullPointerException If  <code>source</code> or <code>returnType</code> is <code>null</code>.
 * @apiSince 8
 */
 ...
 * <code>String</code>.</p>
 *
 * <p>This method calls {@link #evaluate(org.xml.sax.InputSource,javax.xml.namespace.QName)} with a <code>returnType</code> of
 * {@link javax.xml.xpath.XPathConstants#STRING XPathConstants#STRING}.</p>
 *
 * <p>See <a href="#XPathExpression-evaluation">Evaluation of XPath Expressions</a> for context item evaluation,
 * variable, function and QName resolution and return type conversion.</p>
 ...
 *
 * @throws javax.xml.xpath.XPathExpressionException If the expression cannot be evaluated.
 * @throws java.lang.NullPointerException If  <code>source</code> is <code>null</code>.
 * @apiSince 8
 */
