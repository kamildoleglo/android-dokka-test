 ...
 *
 * @exception org.xmlpull.v1.XmlPullParserException If the feature is not supported or can not be set
 * @exception java.lang.IllegalArgumentException If string with the feature name is null
 * @apiSince 1
 */
 ...
 * @exception java.lang.IllegalArgumentException if string the feature name is null
 * @apiSince 1
 */
 ...
 *
 * @exception org.xmlpull.v1.XmlPullParserException If the property is not supported or can not be set
 * @exception java.lang.IllegalArgumentException If string with the property name is null
 * @apiSince 1
 */
